...

{
    ...
    *(awb_pix_cnt + 4) = $t8;
    ...
    int32_t $v1_6;
    $v0_37 = var_60_1_3($s2);
    uint32_t $v0_38 = var_64_1_6($v0_37, $v1_6, $s2);
    ...
    while (i != $s5 * 0xf)
    {
        ...
        while ($v0_40 - $t5_6 < j)
        {
            ...
            if ($t6_4)
            {
                ...
                *($v1_8 + 0xe1) = *(arg2 + $a1_15) / *$a0_18;
                *($v1_8 + 0x1c2) = *(arg3 + $a1_15) / *$a0_18;
            }
            else
            {
                *$v0_40 = 0;
    ...
    label_28448:
        ...
        int32_t var_b0_52;
        int32_t* var_bc_1 = &var_b0_53;
        uint32_t var_b8_27;
        int32_t* var_c0_1 = &var_b8_28;
        
        for (int32_t i_2 = 0; i_2 < 0x38; i_2 += 1)
        {
            void arg_34;
            *(&var_f8_21 + i_2) = *(&arg_34 + i_2);
        }
        ...
        data_98464_2 = var_b8_30;
        data_98428_1 = var_b4_7;
