...

{
    ...
    if (!tx_isp_subdev_init(arg1, $v0, &fs_subdev_ops))
    {
        ...
        *(((void**)((char*)$v0 + 0xe0))) = $a0_2; // Fixed void pointer dereference
        ...
        label_1c670:
            ...
            *(((void**)((char*)$v0 + 0x34))) = &isp_framesource_fops; // Fixed void pointer dereference
        ...
        *(((void**)((char*)$v0 + 0xdc))) = $v0_3; // Fixed void pointer dereference
                ...
                if (*($s6_1 + 5))
                {
                    ...
                    *$s0_2 = 0xff;
                    ...
                    else if (&$s0_2[9] < 0xfffff001)
                    {
                        ...
                        *(((void**)((char*)$s6_1 + 0x1c))) = frame_chan_event; // Fixed void pointer dereference
                        $s0_2[0xb4] = 1;
                        $s2_2 += 1;
                        continue;
                    }
