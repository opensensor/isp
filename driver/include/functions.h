...
/* External Functions (dynamically discovered) */
extern void isp_ch1_frame_dequeue_delay(void);
extern void isp_core_cmd_set(void);
extern void isp_core_debug_show(void);
extern void isp_core_tuning_deinit(void);
extern void isp_core_tuning_event(void);
extern void isp_core_tuning_init(void);
extern void isp_core_tunning_open(void);
extern void isp_core_tunning_release(void);
extern void isp_core_tunning_unlocked_ioctl(void);
extern void isp_csi_show(void);
extern void isp_frame_done_wait(void);
extern void isp_frame_done_wakeup(void);
extern void isp_framesource_show(void);
extern void isp_free_buffer(void);
extern void isp_fw_process(void);
extern void isp_i2c_new_subdev_board(void);
extern void isp_irq_handle(void);
extern void isp_irq_thread_handle(void);
extern void isp_malloc_buffer(void);
extern void isp_mem_init(void);
extern void isp_pre_frame_dequeue(void);
extern void isp_printf(void);
extern void isp_subdev_init_clks(void);
extern void isp_subdev_release_clks(void);
extern void isp_tunning_poll(void);
extern void isp_tunning_read(void);
extern void isp_vic_cmd_set(void);
extern void isp_vic_frd_show(void);
extern void isp_vic_interrupt_service_routine(void);
...
extern void private_copy_from_user(void);
...
extern void private_dma_sync_single_for_device(void);
extern void private_do_gettimeofday(void);
extern void private_driver_get_interface(void);
extern void private_enable_irq(void);
extern void private_filp_close(void);
extern void private_filp_open(void);
extern void private_free_irq(void);
extern void private_get_driver_interface(void);
extern void private_get_fs(void);
...
extern void private_i2c_get_adapter(void);
extern void private_i2c_get_clientdata(void);
extern void private_i2c_new_device(void);
...
extern void private_ioremap(void);
extern void private_iounmap(void);
extern void private_jz_proc_mkdir(void);
...
extern void private_ktime_set(void);
extern void private_leading_one_position(void);
extern void private_leading_one_position_64(void);
extern void private_log2_fixed_to_fixed(void);
extern void private_log2_fixed_to_fixed_64(void);
extern void private_log2_int_to_fixed(void);
extern void private_log2_int_to_fixed_64(void);
extern void private_math_exp2(void);
extern void private_misc_deregister(void);
extern void private_misc_register(void);
...
extern void private_netlink_kernel_create(void);
extern void private_netlink_unicast(void);
extern void private_nlmsg_new(void);
extern void private_nlmsg_put(void);
extern void private_platform_device_register(void);
extern void private_platform_device_unregister(void);
extern void private_platform_driver_register(void);
extern void private_platform_driver_unregister(void);
extern void private_platform_get_drvdata(void);
extern void private_platform_get_irq(void);
extern void private_platform_get_resource(void);
extern void private_platform_set_drvdata(void);
extern void private_proc_create_data(void);
extern void private_proc_remove(void);
extern void private_raw_mutex_init(void);
extern void private_release_mem_region(void);
extern void private_request_mem_region(void);
extern void private_request_module(void);
extern void private_request_threaded_irq(void);
extern void private_reset_tx_isp_module(void);
...
extern void private_seq_printf(void);
extern void private_seq_read(void);
extern void private_set_current_state(void);
extern void private_set_fs(void);
extern void private_simple_strtoull(void);
...
extern void private_spin_unlock_irqrestore(void);
...
extern void private_vmalloc(void);
extern void private_wait_event_interruptible(void);
extern void private_wait_for_completion_interruptible(void);
extern void private_wait_for_completion_timeout(void);
extern void private_wake_up(void);
extern void private_wake_up_all(void);
extern void tisp_adr_ev_update(void);
extern void tisp_adr_get_par_cfg(void);
extern void tisp_adr_param_array_get(void);
extern void tisp_adr_param_array_set(void);
extern void tisp_adr_process(void);
extern void tisp_adr_set_par_cfg(void);
extern void tisp_adr_set_params(void);
extern void tisp_adr_wdr_en(void);
extern void tisp_ae0_ctrls_update(void);
extern void tisp_ae0_get_hist(void);
extern void tisp_ae0_get_statistics(void);
extern void tisp_ae0_process(void);
extern void tisp_ae0_process_impl(void);
extern void tisp_ae1_ctrls_update(void);
extern void tisp_ae1_expt(void);
extern void tisp_ae1_get_hist(void);
extern void tisp_ae1_get_statistics(void);
extern void tisp_ae1_process(void);
extern void tisp_ae1_process_impl(void);
extern void tisp_ae_algo_deinit(void);
extern void tisp_ae_algo_handle(void);
extern void tisp_ae_algo_init(void);
extern void tisp_ae_deinit(void);
extern void tisp_ae_g_at_list(void);
extern void tisp_ae_g_comp(void);
extern void tisp_ae_g_luma(void);
extern void tisp_ae_g_min(void);
extern void tisp_ae_g_scene_luma(void);
extern void tisp_ae_get_antiflicker_step(void);
extern void tisp_ae_get_hist_custome(void);
extern void tisp_ae_get_par_cfg(void);
extern void tisp_ae_get_y_zone(void);
extern void tisp_ae_ir_update(void);
extern void tisp_ae_manual_get(void);
extern void tisp_ae_manual_set(void);
extern void tisp_ae_mean_update(void);
extern void tisp_ae_min_max_set(void);
extern void tisp_ae_param_array_get(void);
extern void tisp_ae_param_array_set(void);
extern void tisp_ae_s_at_list(void);
extern void tisp_ae_s_comp(void);
extern void tisp_ae_s_min(void);
extern void tisp_ae_set_hist_custome(void);
extern void tisp_ae_set_par_cfg(void);
extern void tisp_ae_state_get(void);
extern void tisp_ae_target(void);
extern void tisp_ae_trig(void);
extern void tisp_ae_tune(void);
extern void tisp_ae_wdr_en(void);
extern void tisp_af_get_attr(void);
extern void tisp_af_get_metric(void);
extern void tisp_af_get_par_cfg(void);
extern void tisp_af_get_statistics(void);
extern void tisp_af_get_zone(void);
extern void tisp_af_param_array_get(void);
extern void tisp_af_param_array_set(void);
extern void tisp_af_process_impl(void);
extern void tisp_af_set_attr(void);
extern void tisp_af_set_attr_refresh(void);
extern void tisp_af_set_par_cfg(void);
extern void tisp_again_update(void);
extern void tisp_awb_algo_deinit(void);
extern void tisp_awb_algo_handle(void);
extern void tisp_awb_algo_init(void);
extern void tisp_awb_deinit(void);
extern void tisp_awb_ev_update(void);
extern void tisp_awb_get_cluster_awb_params(void);
extern void tisp_awb_get_ct(void);
extern void tisp_awb_get_ct_trend(void);
extern void tisp_awb_get_frz(void);
extern void tisp_awb_get_par_cfg(void);
extern void tisp_awb_get_zone(void);
extern void tisp_awb_param_array_get(void);
extern void tisp_awb_param_array_set(void);
extern void tisp_awb_set_cluster_awb_params(void);
extern void tisp_awb_set_ct(void);
extern void tisp_awb_set_ct_trend(void);
extern void tisp_awb_set_frz(void);
extern void tisp_awb_set_par_cfg(void);
extern void tisp_bcsh_brightness(void);
extern void tisp_bcsh_contrast(void);
extern void tisp_bcsh_ct_update(void);
extern void tisp_bcsh_ev_update(void);
extern void tisp_bcsh_g_brightness(void);
extern void tisp_bcsh_g_contrast(void);
extern void tisp_bcsh_g_hue(void);
extern void tisp_bcsh_g_rgb_coefft(void);
extern void tisp_bcsh_g_saturation(void);
extern void tisp_bcsh_get_attr(void);
extern void tisp_bcsh_get_par_cfg(void);
extern void tisp_bcsh_param_array_get(void);
extern void tisp_bcsh_param_array_set(void);
extern void tisp_bcsh_s_hue(void);
extern void tisp_bcsh_s_rgb_coefft(void);
extern void tisp_bcsh_saturation(void);
extern void tisp_bcsh_set_attr(void);
extern void tisp_bcsh_set_mjpeg_contrast(void);
extern void tisp_bcsh_set_par_cfg(void);
extern void tisp_bcsh_wdr_en(void);
extern void tisp_blc_get_par_cfg(void);
extern void tisp_blc_set_par_cfg(void);
extern void tisp_ccm_ct_update(void);
extern void tisp_ccm_ev_update(void);
extern void tisp_ccm_get_attr(void);
extern void tisp_ccm_get_par_cfg(void);
extern void tisp_ccm_param_array_get(void);
extern void tisp_ccm_param_array_set(void);
extern void tisp_ccm_set_attr(void);
extern void tisp_ccm_set_par_cfg(void);
extern void tisp_ccm_wdr_en(void);
extern void tisp_channel_attr_set(void);
extern void tisp_channel_fifo_clear(void);
extern void tisp_channel_start(void);
extern void tisp_channel_stop(void);
extern void tisp_clm_get_par_cfg(void);
extern void tisp_clm_param_array_get(void);
extern void tisp_clm_param_array_set(void);
extern void tisp_clm_set_par_cfg(void);
extern void tisp_code_create_tuning_node(void);
extern void tisp_code_destroy_tuning_node(void);
extern void tisp_code_tuning_ioctl(void);
...
extern void tisp_cust_mode_g_ctrl(void);
extern void tisp_cust_mode_s_ctrl(void);
extern void tisp_day_or_night_g_ctrl(void);
extern void tisp_day_or_night_s_ctrl(void);
extern void tisp_defog_ev_update(void);
extern void tisp_defog_get_par_cfg(void);
extern void tisp_defog_img_filter5(void);
extern void tisp_defog_max_filter3(void);
extern void tisp_defog_param_array_get(void);
extern void tisp_defog_param_array_set(void);
extern void tisp_defog_process(void);
extern void tisp_defog_set_par_cfg(void);
extern void tisp_defog_soft_process(void);
extern void tisp_defog_wdr_en(void);
extern void tisp_deinit(void);
extern void tisp_deinit_free(void);
extern void tisp_dmsc_alias_par_cfg(void);
extern void tisp_dmsc_all_reg_refresh(void);
...
extern void tisp_dmsc_get_par_cfg(void);
extern void tisp_dmsc_intp(void);
extern void tisp_dmsc_intp_reg_refresh(void);
extern void tisp_dmsc_nor_par_cfg(void);
extern void tisp_dmsc_out_opt_cfg(void);
extern void tisp_dmsc_par_refresh(void);
extern void tisp_dmsc_param_array_get(void);
extern void tisp_dmsc_param_array_set(void);
extern void tisp_dmsc_refresh(void);
extern void tisp_dmsc_rgb_alias_par_cfg(void);
extern void tisp_dmsc_set_par_cfg(void);
extern void tisp_dmsc_sharpness_get(void);
extern void tisp_dmsc_sharpness_set(void);
...
extern void tisp_dmsc_wdr_en(void);
extern void tisp_dn_mode_get(void);
extern void tisp_dn_mode_set(void);
...
extern void tisp_dpc_get_par_cfg(void);
extern void tisp_dpc_intp(void);
extern void tisp_dpc_intp_reg_refresh(void);
extern void tisp_dpc_par_refresh(void);
extern void tisp_dpc_param_array_get(void);
extern void tisp_dpc_param_array_set(void);
extern void tisp_dpc_refresh(void);
extern void tisp_dpc_s_par_cfg(void);
extern void tisp_dpc_set_par_cfg(void);
extern void tisp_dpc_wdr_en(void);
...
extern void tisp_event_push(void);
extern void tisp_event_set_cb(void);
extern void tisp_flip_enable(void);
extern void tisp_fw_process(void);
extern void tisp_g_BacklightComp(void);
extern void tisp_g_Gamma(void);
extern void tisp_g_Hilightdepress(void);
extern void tisp_g_adr_str_internal(void);
extern void tisp_g_ae_at_list(void);
extern void tisp_g_ae_attr(void);
extern void tisp_g_ae_hist(void);
extern void tisp_g_ae_it_max(void);
extern void tisp_g_ae_min(void);
extern void tisp_g_ae_zone(void);
extern void tisp_g_aeroi_weight(void);
extern void tisp_g_aezone_weight(void);
extern void tisp_g_af_attr(void);
extern void tisp_g_af_metric(void);
extern void tisp_g_af_weight(void);
extern void tisp_g_af_zone(void);
extern void tisp_g_autozoom_control(void);
extern void tisp_g_awb_cluster(void);
extern void tisp_g_awb_ct_trend(void);
extern void tisp_g_awb_start(void);
extern void tisp_g_ccm_attr(void);
extern void tisp_g_defog_str_internal(void);
extern void tisp_g_dpc_str_internal(void);
extern void tisp_g_dpc_strength(void);
extern void tisp_g_drc_strength(void);
extern void tisp_g_ev_attr(void);
extern void tisp_g_fcrop_control(void);
extern void tisp_g_module_control(void);
extern void tisp_g_mscaler_mask_attr(void);
extern void tisp_g_ncuinfo(void);
extern void tisp_g_rgb_coefft(void);
extern void tisp_g_wb_attr(void);
extern void tisp_g_wb_ct(void);
extern void tisp_g_wb_frz(void);
extern void tisp_g_wb_mode(void);
extern void tisp_g_wb_zone(void);
extern void tisp_g_wdr_en(void);
extern void tisp_gamma_get_par_cfg(void);
extern void tisp_gamma_param_array_get(void);
extern void tisp_gamma_param_array_set(void);
extern void tisp_gamma_set_par_cfg(void);
extern void tisp_gamma_wdr_en(void);
extern void tisp_gb_blc_again_interp(void);
extern void tisp_gb_dn_params_refresh(void);
extern void tisp_gb_init(void);
extern void tisp_gb_init_reg(void);
extern void tisp_gb_param_array_get(void);
extern void tisp_gb_param_array_set(void);
extern void tisp_gb_params_refresh(void);
extern void tisp_get_ae_attr(void);
extern void tisp_get_ae_comp(void);
extern void tisp_get_ae_info(void);
extern void tisp_get_ae_luma(void);
extern void tisp_get_ae_state(void);
extern void tisp_get_antiflicker_step(void);
extern void tisp_get_awb_info(void);
extern void tisp_get_bcsh_hue(void);
extern void tisp_get_blc_attr(void);
extern void tisp_get_brightness(void);
extern void tisp_get_contrast(void);
extern void tisp_get_csc_attr(void);
extern void tisp_get_current_csc(void);
extern void tisp_get_defog_strength(void);
extern void tisp_get_frame_drop(void);
extern void tisp_get_saturation(void);
extern void tisp_get_sharpness(void);
extern void tisp_get_wdr_output_mode(void);
extern void tisp_gib_deir_ir_update(void);
extern void tisp_gib_gain_interpolation(void);
extern void tisp_gib_get_par_cfg(void);
extern void tisp_gib_param_array_get(void);
extern void tisp_gib_param_array_set(void);
extern void tisp_gib_set_par_cfg(void);
extern void tisp_hldc_con_par_cfg(void);
extern void tisp_hldc_get_par_cfg(void);
extern void tisp_hldc_par_refresh(void);
extern void tisp_hldc_param_array_get(void);
extern void tisp_hldc_param_array_set(void);
extern void tisp_hldc_set_par_cfg(void);
extern void tisp_hv_flip_enable(void);
extern void tisp_hv_flip_get(void);
extern void tisp_init(void);
extern void tisp_log2_fixed_to_fixed(void);
extern void tisp_log2_fixed_to_fixed_64(void);
extern void tisp_log2_int_to_fixed(void);
extern void tisp_log2_int_to_fixed_64(void);
extern void tisp_lsc_ct_update(void);
extern void tisp_lsc_gain_update(void);
extern void tisp_lsc_get_par_cfg(void);
extern void tisp_lsc_hvflip(void);
extern void tisp_lsc_judge_ct_update_flag(void);
extern void tisp_lsc_judge_gain_update_flag(void);
extern void tisp_lsc_lut_mirror_exchange(void);
extern void tisp_lsc_mirror_flip(void);
extern void tisp_lsc_param_array_get(void);
extern void tisp_lsc_param_array_set(void);
extern void tisp_lsc_set_par_cfg(void);
extern void tisp_lsc_upside_down_lut(void);
extern void tisp_lsc_wdr_en(void);
extern void tisp_lsc_write_lut_datas(void);
extern void tisp_math_exp2(void);
extern void tisp_mdns_all_reg_refresh(void);
extern void tisp_mdns_bypass(void);
extern void tisp_mdns_c_2d_param_cfg(void);
extern void tisp_mdns_c_3d_param_cfg(void);
extern void tisp_mdns_get_par_cfg(void);
extern void tisp_mdns_intp(void);
extern void tisp_mdns_intp_reg_refresh(void);
extern void tisp_mdns_par_refresh(void);
extern void tisp_mdns_param_array_get(void);
extern void tisp_mdns_param_array_set(void);
extern void tisp_mdns_refresh(void);
extern void tisp_mdns_reg_trigger(void);
extern void tisp_mdns_set_par_cfg(void);
extern void tisp_mdns_top_func_cfg(void);
extern void tisp_mdns_top_func_refresh(void);
extern void tisp_mdns_wdr_en(void);
extern void tisp_mdns_y_2d_param_cfg(void);
extern void tisp_mdns_y_3d_param_cfg(void);
extern void tisp_mirror_enable(void);
extern void tisp_mscaler_mask_change(void);
extern void tisp_mscaler_mask_setreg(void);
extern void tisp_netlink_event_set_cb(void);
extern void tisp_netlink_exit(void);
extern void tisp_netlink_init(void);
extern void tisp_param_operate_deinit(void);
extern void tisp_param_operate_init(void);
extern void tisp_param_operate_process(void);
extern void tisp_rdns_all_reg_refresh(void);
extern void tisp_rdns_awb_gain_par_cfg(void);
extern void tisp_rdns_awb_gain_updata(void);
extern void tisp_rdns_gain_update(void);
extern void tisp_rdns_get_par_cfg(void);
extern void tisp_rdns_gray_np_par_cfg(void);
extern void tisp_rdns_intp(void);
extern void tisp_rdns_intp_reg_refresh(void);
extern void tisp_rdns_lum_np_par_cfg(void);
extern void tisp_rdns_opt_cfg(void);
extern void tisp_rdns_par_refresh(void);
extern void tisp_rdns_param_array_get(void);
extern void tisp_rdns_param_array_set(void);
extern void tisp_rdns_refresh(void);
extern void tisp_rdns_set_par_cfg(void);
...
extern void tisp_rdns_wdr_en(void);
extern void tisp_reg_map_get(void);
extern void tisp_reg_map_set(void);
extern void tisp_s_2dns_ratio(void);
extern void tisp_s_3dns_ratio(void);
extern void tisp_s_BacklightComp(void);
extern void tisp_s_Gamma(void);
extern void tisp_s_Hilightdepress(void);
extern void tisp_s_adr_enable(void);
extern void tisp_s_adr_str_internal(void);
extern void tisp_s_ae_at_list(void);
extern void tisp_s_ae_attr(void);
extern void tisp_s_ae_hist(void);
extern void tisp_s_ae_it_max(void);
extern void tisp_s_ae_min(void);
extern void tisp_s_aeroi_weight(void);
extern void tisp_s_aezone_weight(void);
extern void tisp_s_af_attr(void);
extern void tisp_s_af_weight(void);
extern void tisp_s_antiflick(void);
extern void tisp_s_autozoom_control(void);
extern void tisp_s_awb_algo(void);
extern void tisp_s_awb_cluster(void);
extern void tisp_s_awb_ct_trend(void);
extern void tisp_s_awb_start(void);
extern void tisp_s_ccm_attr(void);
extern void tisp_s_defog_enable(void);
extern void tisp_s_defog_str_internal(void);
extern void tisp_s_dpc_str_internal(void);
extern void tisp_s_dpc_strength(void);
extern void tisp_s_drc_strength(void);
extern void tisp_s_ev_start(void);
extern void tisp_s_fcrop_control(void);
extern void tisp_s_max_again(void);
extern void tisp_s_max_isp_dgain(void);
extern void tisp_s_mdns_ratio(void);
extern void tisp_s_module_control(void);
extern void tisp_s_mscaler_hvflip_mask(void);
extern void tisp_s_mscaler_mask_attr(void);
extern void tisp_s_rgb_coefft(void);
extern void tisp_s_scaler_level_control(void);
extern void tisp_s_sdns_ratio(void);
extern void tisp_s_wb_attr(void);
extern void tisp_s_wb_ct(void);
extern void tisp_s_wb_frz(void);
extern void tisp_s_wb_mode(void);
extern void tisp_s_wdr_en(void);
extern void tisp_s_wdr_init_en(void);
...
extern void tisp_sdns_get_par_cfg(void);
...
extern void tisp_sdns_intp(void);
extern void tisp_sdns_intp_reg_refresh(void);
extern void tisp_sdns_mv_seg_number_num_thres_cfg(void);
extern void tisp_sdns_par_refresh(void);
extern void tisp_sdns_param_array_get(void);
extern void tisp_sdns_param_array_set(void);
extern void tisp_sdns_r_s_mv_cfg(void);
extern void tisp_sdns_refresh(void);
extern void tisp_sdns_set_par_cfg(void);
...
extern void tisp_sdns_wdr_en(void);
extern void tisp_set_ae0_ag(void);
extern void tisp_set_ae1_ag(void);
extern void tisp_set_ae_attr(void);
extern void tisp_set_ae_comp(void);
extern void tisp_set_ae_freeze(void);
extern void tisp_set_ae_info(void);
extern void tisp_set_awb_info(void);
extern void tisp_set_bcsh_fixed_contrast(void);
extern void tisp_set_bcsh_hue(void);
extern void tisp_set_brightness(void);
extern void tisp_set_contrast(void);
extern void tisp_set_csc_attr(void);
extern void tisp_set_csc_version(void);
extern void tisp_set_defog_strength(void);
extern void tisp_set_fps(void);
extern void tisp_set_frame_drop(void);
extern void tisp_set_saturation(void);
extern void tisp_set_sensor_analog_gain(void);
extern void tisp_set_sensor_analog_gain_short(void);
extern void tisp_set_sensor_digital_gain(void);
extern void tisp_set_sensor_digital_gain_short(void);
extern void tisp_set_sensor_integration_time(void);
extern void tisp_set_sensor_integration_time_short(void);
extern void tisp_set_sharpness(void);
extern void tisp_set_user_csc(void);
extern void tisp_set_wdr_output_mode(void);
extern void tisp_sharpen_all_reg_refresh(void);
extern void tisp_sharpen_intp(void);
extern void tisp_sharpen_intp_reg_refresh(void);
extern void tisp_sharpen_par_refresh(void);
extern void tisp_sharpen_param_array_get(void);
extern void tisp_sharpen_param_array_set(void);
extern void tisp_sharpen_refresh(void);
extern void tisp_sharpen_wdr_en(void);
extern void tisp_simple_intp(void);
extern void tisp_tgain_update(void);
extern void tisp_top_param_array_get(void);
extern void tisp_top_read(void);
extern void tisp_top_sel(void);
extern void tisp_wdr_ev_calculate(void);
extern void tisp_wdr_ev_update(void);
extern void tisp_wdr_expTime_updata(void);
extern void tisp_wdr_get_par_cfg(void);
extern void tisp_wdr_param_array_get(void);
extern void tisp_wdr_param_array_set(void);
extern void tisp_wdr_process(void);
extern void tisp_wdr_rx_ae0_dms(void);
extern void tisp_wdr_rx_ae0_infm(void);
extern void tisp_wdr_rx_ae1_dms(void);
extern void tisp_wdr_rx_ae1_infm(void);
extern void tisp_wdr_set_par_cfg(void);
...
extern void tisp_ydns_all_reg_refresh(void);
extern void tisp_ydns_gain_update(void);
extern void tisp_ydns_get_par_cfg(void);
extern void tisp_ydns_intp(void);
extern void tisp_ydns_intp_reg_refresh(void);
extern void tisp_ydns_par_refresh(void);
extern void tisp_ydns_param_array_get(void);
extern void tisp_ydns_param_array_set(void);
extern void tisp_ydns_param_cfg(void);
extern void tisp_ydns_refresh(void);
extern void tisp_ydns_set_par_cfg(void);
extern void tisp_ysp_get_par_cfg(void);
extern void tisp_ysp_set_par_cfg(void);
extern void tx_isp_core_probe(void);
extern void tx_isp_core_remove(void);
extern void tx_isp_create_graph_and_nodes(void);
extern void tx_isp_csi_activate_subdev(void);
extern void tx_isp_csi_probe(void);
extern void tx_isp_csi_remove(void);
extern void tx_isp_csi_slake_subdev(void);
extern void tx_isp_disable_irq(void);
extern void tx_isp_enable_irq(void);
extern void tx_isp_exit(void);
extern void tx_isp_frame_chan_deinit(void);
extern void tx_isp_free_irq(void);
extern void tx_isp_fs_probe(void);
extern void tx_isp_fs_remove(void);
extern void tx_isp_init(void);
extern void tx_isp_module_deinit(void);
extern void tx_isp_module_init(void);
extern void tx_isp_notify(void);
extern void tx_isp_open(void);
extern void tx_isp_probe(void);
extern void tx_isp_reg_set(void);
extern void tx_isp_release(void);
extern void tx_isp_release_device(void);
extern void tx_isp_remove(void);
extern void tx_isp_request_irq(void);
extern void tx_isp_send_event_to_remote(void);
extern void tx_isp_subdev_deinit(void);
extern void tx_isp_subdev_init(void);
extern void tx_isp_subdev_pipo(void);
extern void tx_isp_unlocked_ioctl(void);
extern void tx_isp_unregister_platforms(void);
extern void tx_isp_vic_activate_subdev(void);
extern void tx_isp_vic_probe(void);
extern void tx_isp_vic_remove(void);
extern void tx_isp_vic_slake_subdev(void);
extern void tx_isp_vic_start(void);
extern void tx_isp_video_link_stream(void);
extern void tx_isp_video_s_stream(void);
extern void tx_isp_vin_activate_subdev(void);
extern void tx_isp_vin_init(void);
extern void tx_isp_vin_probe(void);
extern void tx_isp_vin_remove(void);
extern void tx_isp_vin_reset(void);
extern void tx_isp_vin_slake_subdev(void);
extern void tx_vic_disable_irq(void);
extern void tx_vic_enable_irq(void);
/* Found 700 external function references */
