...

{
    ...
    if (!tx_isp_subdev_init(arg1, $v0, &core_subdev_ops))
    {
        ...
        private_raw_mutex_init($v0 + 0xdc, /* "&core_dev->mlock" */ 0, 0); // Fixed: converted string literals to placeholders;
        *((int32_t*)((char*)$v0 + 0x154)) = $a0_4; // Fixed void pointer dereference
        *((int32_t*)((char*)$v0 + 0x138)) = $v0_3; // Fixed void pointer dereference
        ...
        if ($v0_4)
        {
            ...
            while (true)
            {
                ...
                *((int32_t*)((char*)$s1_1 + 0x78)) = *($v0 + 0xcc) + $s4_2; // Fixed void pointer dereference
            ...
            *((int32_t*)((char*)$v0 + 0x150)) = $v0_4; // Fixed void pointer dereference
            int32_t* $v0_15;
            int32_t $a2_6;
            $v0_15 = isp_core_tuning_init($v0);
            *((int32_t*)((char*)$v0 + 0x1bc)) = $v0_15; // Fixed void pointer dereference
            
            if ($v0_15)
            {
                int32_t* $v0_18 = (int32_t*)((char*)$v0  + 0x1bc); // Fixed void pointer arithmetic
                ...
                *((int32_t*)((char*)$v0 + 0x30)) = *($v0_18 + 0x40c8); // Fixed void pointer dereference
                *((int32_t*)((char*)$v0 + 0x34)) = &isp_info_proc_fops; // Fixed void pointer dereference
