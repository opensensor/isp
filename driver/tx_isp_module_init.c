...

{
    ...
    *(((void**)((char*)arg2 + 8))) = *arg1; // Fixed void pointer dereference
    *(((void**)((char*)arg2 + 0x7c))) = tx_isp_notify; // Fixed void pointer dereference
    *(((int32_t*)((char*)arg2 + 0x30))) = 0; // Fixed void pointer dereference
    *(((int32_t*)((char*)arg2 + 0x34))) = 0; // Fixed void pointer dereference
    *(((void**)((char*)arg2 + 4))) = &arg1[4]; // Fixed void pointer dereference
    return 0;
}
