...
static void vic_start_adjustment(void)
{
    ...
    pr_info("*** TIMER ADJUSTMENT: Skipping Core Control registers 0xb018-0xb024 to preserve interrupts ***\n");
    /* writel(0x24242424, isp_base + 0xb018); // SKIPPED - kills VIC interrupts */
    /* writel(0x24242424, isp_base + 0xb01c); // SKIPPED - kills VIC interrupts */
    /* writel(0x24242424, isp_base + 0xb020); // SKIPPED - kills VIC interrupts */
    /* writel(0x242424, isp_base + 0xb024);   // SKIPPED - kills VIC interrupts */
