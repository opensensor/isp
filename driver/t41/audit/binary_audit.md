...
| collapsed | exact_name | `tisp_awb_ct_detect` | `tisp_awb_ct_detect` | 3100 | 1061 | 0.342 | -2039 | 41->23 | 362->148 |
| collapsed | exact_name | `tx_isp_core_ops_s_ctrl` | `tx_isp_core_ops_s_ctrl` | 1768 | 257 | 0.145 | -1511 | 150->23 | 226->40 |
| collapsed | exact_name | `tx_isp_core_ops_g_ctrl` | `tx_isp_core_ops_g_ctrl` | 1386 | 651 | 0.470 | -735 | 100->50 | 201->126 |
| collapsed | exact_name | `tisp_ae_ev_list_alloc_calc` | `tisp_ae_ev_list_alloc_calc` | 1332 | 334 | 0.251 | -998 | 67->11 | 201->65 |
...
| collapsed | exact_name | `tisp_ae_ev_alloc_calc` | `tisp_ae_ev_alloc_calc` | 931 | 313 | 0.336 | -618 | 50->15 | 126->53 |
| collapsed | exact_name | `Tisp_lce_soft` | `Tisp_lce_soft` | 915 | 65 | 0.071 | -850 | 39->7 | 83->3 |
| collapsed | exact_name | `tisp_awb_long_alogrithm` | `tisp_awb_long_alogrithm` | 863 | 429 | 0.497 | -434 | 14->11 | 80->46 |
...
| collapsed | exact_name | `tisp_ae_short_ev_alloc_calc` | `tisp_ae_short_ev_alloc_calc` | 672 | 98 | 0.146 | -574 | 40->1 | 102->16 |
...
| collapsed | exact_name | `Tiziano_Awb_Ct_Cal` | `Tiziano_Awb_Ct_Cal` | 206 | 52 | 0.252 | -154 | 4->2 | 22->4 |
| collapsed | exact_name | `tisp_clm_write_csc_para` | `tisp_clm_write_csc_para` | 198 | 71 | 0.359 | -127 | 16->5 | 0->0 |
| collapsed | exact_name | `tisp_g_module_attr` | `tisp_g_module_attr` | 189 | 51 | 0.270 | -138 | 4->3 | 29->4 |
...
| collapsed | exact_name | `func_local_info` | `func_local_info` | 121 | 49 | 0.405 | -72 | 10->5 | 2->2 |
...
| collapsed | exact_name | `tisp_ae_calc_convergence_speed` | `tisp_ae_calc_convergence_speed` | 70 | 31 | 0.443 | -39 | 4->2 | 2->1 |
...
| collapsed | exact_name | `ISPAWBInterpolation1` | `ISPAWBInterpolation1` | 45 | 20 | 0.444 | -25 | 4->2 | 2->0 |
...
| collapsed | exact_name | `fix_point_div_32` | `fix_point_div_32` | 34 | 11 | 0.324 | -23 | 1->0 | 4->3 |
...
| shorter | exact_name | `tisp_init` | `tisp_init` | 680 | 418 | 0.615 | -262 | 87->47 | 39->39 |
...
| shorter | exact_name | `subsection_up` | `subsection_up` | 530 | 285 | 0.538 | -245 | 31->18 | 20->17 |
...
| shorter | exact_name | `tisp_ae_sensor_par_ctrls_update` | `tisp_ae_sensor_par_ctrls_update` | 325 | 187 | 0.575 | -138 | 7->5 | 17->11 |
...
| shorter | exact_name | `tisp_ae_short_sensor_par_ctrls_update` | `tisp_ae_short_sensor_par_ctrls_update` | 224 | 137 | 0.612 | -87 | 2->2 | 16->11 |
| shorter | exact_name | `tisp_awb_set_gain` | `tisp_awb_set_gain` | 222 | 173 | 0.779 | -49 | 13->11 | 12->11 |
...
| shorter | exact_name | `tisp_ae_set_hardware_param` | `tisp_ae_set_hardware_param` | 200 | 152 | 0.760 | -48 | 9->16 | 5->11 |
...
| shorter | exact_name | `tisp_ae_api_set_scene_par` | `tisp_ae_api_set_scene_par` | 131 | 103 | 0.786 | -28 | 3->2 | 14->15 |
...
| shorter | exact_name | `ivdc_misc_unlocked_ioctl` | `ivdc_misc_unlocked_ioctl` | 112 | 82 | 0.732 | -30 | 6->4 | 17->15 |
...
| shorter | exact_name | `frame_channel_vidioc_get_fmt` | `frame_channel_vidioc_get_fmt` | 97 | 67 | 0.691 | -30 | 7->5 | 9->9 |
