...

{
    ...
    uint32_t var_b8_44 = fix_point_mult3_32($s0, $v0_31, $v0_32);
    ...
    *(arg8 + 0x38) = arg27;
    ...
    if (IspAeFlag_1 == 1)
    {
        ...
        else
        {
            ...
            data_b0e0c_1 = 0;
            var_b8_46 = ae_ev_init_strict_1 << ($s0 & 0x1f);
            ae_ev_init_en = 0;
            $a0_19 = var_b8_47;
        }
    ...
    int32_t $v0_69 = fix_point_mult2_32($s0, var_b8_48, $v0_68);
    int32_t var_170_4;
    int32_t var_16c_21;
    int32_t var_168_12;
    int32_t var_164_13;
                ...
                *arg7 = $s5;
                ...
                if ($s6_2 >= $s5)
                {
                    ...
                    if (-($v0_1) >= -($v0_75))
                    {
                        ...
                        int32_t var_70_4_2 = $v0_99;
                        int32_t var_6c_2_2 = $v1_41;
                        int32_t $v0_100;
                        int32_t $v1_42;
                    ...
                    else
                    {
                        ...
                        int32_t $v1_39;
                        $v0_96 =
                            fix_point_div_64($t0_8, $a1_30, $v0_94, $v1_37, var_170_2_4, var_16c_2_4);
                        $v0_97 = $v0_91 - $v0_96;
                ...
                else
                {
                    ...
                    if ($a3_4 >= $v0_75)
                    {
                        ...
                        int32_t $v0_88;
                        int32_t $v1_31;
                        $v0_88 = fix_point_mult3_64($s0 << 1, $a1_28, $v0_87, $v1_30, var_170_2_6, 
                            var_16c_2_6, var_168_16, var_164_17);
                        $v0_84 = $v0_88 + $v0_85;
                    ...
                    else
                    {
                        ...
                        int32_t var_70_1_4 = $v0_80;
                        int32_t var_6c_1_2 = $v1_24;
                        int32_t $v0_81;
                        int32_t $v1_25;
                ...
                int32_t $v0_106;
                int32_t $v1_48;
                $v0_106 = __ashldi3($a0_51, 0, $s0, $a3_12, var_170_2_8, var_16c_2_8, var_168_17, var_164_18);
                var_170_5 = $v0_106;
                var_16c_22 = $v1_48;
                int32_t $v0_108;
                int32_t $v1_49;
                $v0_108 = var_94_1_6($t1_10);
                uint32_t $v0_109;
                int32_t $v1_50;
    ...
    if (var_b8_59 != $s2_2 || data_b0e08_1 || !data_b0e0c_2)
    {
        ...
        if ($v0_115)
        {
            ...
            if (var_84_8($s0, $s4_4, var_d4_5, var_d0_7, var_170_6, var_16c_23, var_168_18, var_164_19) >= $s2_2)
                goto label_611d8;
            
            int32_t $v0_175 = fix_point_div_32($s0, $s2_2, $s4_4);
            
            if (fix_point_mult2_32($s0, $v0_21, var_d0_8) >= $v0_175)
            {
                var_d4_6 = fix_point_div_32($s0, $s2_2, fix_point_mult2_32($s0, $s4_4, var_d0_9));
                goto label_611d0;
            }
        ...
        {
            int32_t $v0_116 = fix_point_mult2_32($s0, var_d4_9, var_d0_11);
            ...
            int32_t $s7_1 = fix_point_div_32($s0, $v0_23, var_d0_12);
            ...
            else if ($s2_3 < $v0_121)
            {
                ...
                if (var_84_9($s0, $s2_3, $fp_4, $s7_1, var_170_7, var_16c_24, var_168_19, var_164_20) >= $v0_121)
                {
            ...
            var_d0_13 = fix_point_mult2_32($s0, $s7_1, var_d0_14);
