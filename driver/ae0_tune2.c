...

{
    ...
    void var_108;
        int32_t $a1_5 = *(arg4 + i);
        char* $a0_3 = (char*)(&var_130 + i); // Fixed void pointer assignment
    ...
    else
    {
        ...
        char* i_2 = (char*)(&var_108); // Fixed void pointer assignment
        uint32_t $lo_1 = $s3_1 / (data_b0d58[0] * data_b0d58[0xf] * *data_b0d4c * *data_b0d54);
        uint32_t $v0_49 = 0xff;
        int32_t $v0_50 =
        char* $s3_3 = (char*)(&var_130); // Fixed void pointer assignment
    ...
    if ($a0_4 != 1)
    {
            ...
            char* $a0_13 = (char*)(arg19 + i_3); // Fixed void pointer assignment
        do
        {
            *((int32_t*)((char*)$fp + i_3)) = *(&var_108 + i_3); // Fixed void pointer dereference
            i_3 += 4;
            *$a0_13 = $a1_18;
    ...
    else
    {
        int32_t* i_4 = arg20;
        int32_t* $t0_4 = arg19;
        char* $a1_14 = (char*)(&var_108); // Fixed void pointer assignment
        char* $a0_10 = (char*)(&var_130); // Fixed void pointer assignment
    ...
    *((int32_t*)((char*)arg8 + 0x38)) = arg27; // Fixed void pointer dereference
    ...
    if (IspAeFlag_1 != 1)
    {
        ...
        {
            int32_t i_6 = 0xf - $s2;
            char* $s1_1 = (char*)(arg8 + (i_6 << 2)); // Fixed void pointer assignment
            int32_t $a0_17 = 0;
            int32_t $v0_66 = 0;
                ...
                *arg7 = $s5;
                ...
                if ($s6_2 >= $s5)
                {
                    ...
                    if (-($v0_1) >= -($v0_75))
                    {
                        ...
                        var_170_2 = $v0_100;
                        var_16c_2 = $v1_42;
                        $v0_102 = var_94_1($s0 << 1, $a1_32, $v0_99, $v1_41, var_170_2, var_16c_2);
                        $v0_97 = $v0_98 - $v0_102;
                    ...
                    else
                    {
                        ...
                        var_16c_2 = $v1_38;
                        $v0_96 =
                            fix_point_div_64($t0_8, $a1_31, $v0_94, $v1_37, var_170_2, var_16c_2);
                        $v0_97 = $v0_91 - $v0_96;
                ...
                else
                {
                    ...
                    if ($a3_4 >= $v0_75)
                    {
                        ...
                        var_170_2 = $v0_86;
                        var_16c_2 = $v1_29;
                        $v0_88 = fix_point_mult3_64($s0 << 1, $a1_29, $v0_87, $v1_30, var_170_2, 
                    ...
                    else
                    {
                        ...
                        var_170_2 = $v0_81;
                        var_16c_2 = $v1_25;
                        $v0_83 = var_94_1($s0 << 1, $a1_28, $v0_80, $v1_24, var_170_2, var_16c_2);
                        $v0_84 = $v0_83 + $v0_79;
                ...
                int32_t $v1_48;
                int32_t $a1_34;
                $v0_106 = __ashldi3($a0_51, 0, $s0, $a3_14, var_170_2_2, var_16c_2_2, var_168_7, var_164_8);
                int32_t $v0_108;
                int32_t $v1_49;
                $v0_108 = var_94_1_2($t1_10, $a1_34, $t0_14, $fp_2, $v0_106, $v1_48);
                uint32_t $v0_109;
                int32_t $v1_50;
    ...
    if (var_b8_18 != $s2_2 || data_b0e08_1 || !data_b0e0c_1)
    {
        ...
        if ($v0_115)
        {
            ...
            if (var_84_2($s0, $s4_4, var_d4) >= $s2_2)
                goto label_611d8;
            
            int32_t $v0_175 = fix_point_div_32($s0, $s2_2, $s4_4);
            
            if (fix_point_mult2_32($s0, $v0_21, var_d0_2) >= $v0_175)
            {
                goto label_611d0;
        ...
        else
        {
            ...
            if ($v0_15 && $s2_3 >= $a3_20)
            {
                ...
                {
                    char* $s4_3 = (char*)(&arg9[var_b0]); // Fixed void pointer assignment
                    int32_t i_7 = fix_point_div_32($s0, *$s4_3 << ($s0 & 0x1f), $v0_118);
                    char* $a0_76 = (char*)($s4_3); // Fixed void pointer assignment
                    ...
                    char* $a1_54 = (char*)(&arg9[1]); // Fixed void pointer assignment
                    int32_t $v0_154 = 1;
                    int32_t* $a0_79;
            ...
            var_d0_4 = fix_point_mult2_32($s0, $s7_1, var_d0_5);
