...
| Executable section bytes | 205504 | 490360 |
| Initialized writable bytes | 43624 | 91096 |
| Uninitialized writable bytes | 34116 | 39024 |

- direct matches: 711
- replacement matches: 10 (missing=0)
- unmatched: OEM-only=21 recovered-only=151
- matched instructions: OEM=49162 recovered=102523 ratio=2.085
- classes: stub=0 collapsed=0 shorter=3 same_count=2 similar=27 larger=279 expanded=410
...
| `.reginfo` | 24 | 24 | +0 |
| `.rodata` | 10448 | 28576 | +18128 |
| `.rodata.cst16` | 16 | 0 | -16 |
| `.rodata.cst4` | 12 | 0 | -12 |
| `.rodata.cst8` | 8 | 0 | -8 |
| `.rodata.str1.4` | 12308 | 0 | -12308 |
| `.sbss` | 100 | 0 | -100 |
| `.text` | 203680 | 489792 | +286112 |
...
Showing 250 of 864 outliers. JSON and CSV contain every comparison row.
...
| expanded | replacement | `isp_core_ops_ioctl` | `isp_core_frame_channel_crop_capture`<br>`isp_core_frame_channel_enum_fmt`<br>`isp_core_frame_channel_queue_buffer`<br>`isp_core_frame_channel_scaler_capture`<br>`isp_core_frame_channel_set_crop`<br>`isp_core_frame_channel_set_fmt`<br>`isp_core_frame_channel_set_scaler`<br>`isp_core_frame_channel_streamoff`<br>`isp_core_frame_channel_streamon`<br>`isp_core_frame_channel_try_fmt`<br>`isp_core_ops_ioctl`<br>`isp_core_ops_private_ioctl`<br>`isp_core_set_clk` | 1003 | 2581 | 2.573 | +1578 | 72->93 | 139->190 |
| expanded | exact_name | `isp_info_show` | `isp_info_show` | 799 | 1780 | 2.228 | +981 | 144->144 | 10->24 |
| expanded | exact_name | `isp_core_interrupt_service_routine` | `isp_core_interrupt_service_routine` | 677 | 1513 | 2.235 | +836 | 59->58 | 72->130 |
