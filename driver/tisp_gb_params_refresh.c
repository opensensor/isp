...

{
    ...
    memcpy(&tisp_gb_blc_ir[0x1b], &data_a7344_1[9], 0x24);
    memcpy(&tisp_gb_blc_ir[0x12], &data_a7344_2[0x12], 0x24);
    memcpy(&tisp_gb_blc_ir[9], &data_a7344_3[0x1b], 0x24);
    memcpy(U"A?CB?????A?CB?????A?CB?????A?CB?????A?CB?????", U"A?CB?????", 0x24);
    memcpy(&tisp_gb_blc_min_en, &data_a73d4_1[9], 8);
