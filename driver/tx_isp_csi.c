...
/* Post-streaming CSI hardware configuration - matches spec driver behavior */
                                           ...
                                           struct tx_isp_sensor_attribute *attr)
{
    ...
    pr_info("=== PERFORMING POST-STREAMING CSI CONFIGURATION ===\n");
    pr_info("Configuring CSI for %d lanes, format %d\n", lanes, attr->mipi.mipi_sc.sensor_csi_fmt);
    
    /* STEP 1: Extended CSI PHY Control configuration (0x0-0xff range) */
    pr_info("Step 1: CSI PHY Control configuration\n");
    
    /* Base configuration registers */
    writel(0x7d, csi_base + 0x00);      /* VERSION/ID register */
    writel(0xe3, csi_base + 0x04);      /* Extended lane config */
    writel(0xa0, csi_base + 0x08);      /* PHY shutdown extended */
    writel(0x83, csi_base + 0x0c);      /* DPHY reset extended */
    writel(0xfa, csi_base + 0x10);      /* CSI2 reset extended */
    wmb();
    
    /* Advanced PHY timing registers */
    writel(0x88, csi_base + 0x1c);      /* PHY timing 1 */
    writel(0x4e, csi_base + 0x20);      /* PHY timing 2 */
    writel(0xdd, csi_base + 0x24);      /* PHY timing 3 */
    writel(0x84, csi_base + 0x28);      /* PHY timing 4 */
    writel(0x5e, csi_base + 0x2c);      /* PHY timing 5 */
    writel(0xf0, csi_base + 0x30);      /* PHY timing 6 */
    writel(0xc0, csi_base + 0x34);      /* PHY timing 7 */
    writel(0x36, csi_base + 0x38);      /* PHY timing 8 */
    writel(0xdb, csi_base + 0x3c);      /* PHY timing 9 */
    wmb();
    
    /* Lane-specific configuration */
    writel(0x03, csi_base + 0x40);      /* Lane control 1 */
    writel(0x80, csi_base + 0x44);      /* Lane control 2 */
    writel(0x10, csi_base + 0x48);      /* Lane control 3 */
    writel(0x03, csi_base + 0x54);      /* Lane enable */
    writel(0xff, csi_base + 0x58);      /* Lane mask */
    writel(0x42, csi_base + 0x5c);      /* Lane config */
    wmb();
    
    /* Data lane configuration */
    writel(0x01, csi_base + 0x60);      /* Data lane 0 */
    writel(0xc0, csi_base + 0x64);      /* Data lane 1 */
    writel(0xc0, csi_base + 0x68);      /* Data lane 2 */
    writel(0x78, csi_base + 0x6c);      /* Data lane 3 */
    writel(0x43, csi_base + 0x70);      /* Clock lane config */
    writel(0x33, csi_base + 0x74);      /* Clock lane timing */
    wmb();
    
    /* Advanced control registers */
    writel(0x1f, csi_base + 0x80);      /* Control register 1 */
    writel(0x61, csi_base + 0x88);      /* Control register 2 */
    wmb();
    
    private_msleep(10); /* Allow PHY to stabilize */
    
    /* STEP 2: CSI PHY Config configuration (0x100-0x1ff range) */
    pr_info("Step 2: CSI PHY Config configuration\n");
    
    /* Basic PHY configuration */
    writel(0x8a, csi_base + 0x100);     /* PHY config base */
    writel(0x05, csi_base + 0x104);     /* PHY config 1 */
    writel(0x40, csi_base + 0x10c);     /* PHY config 2 */
    writel(0xb0, csi_base + 0x110);     /* PHY config 3 */
    writel(0xc5, csi_base + 0x114);     /* PHY config 4 */
    writel(0x03, csi_base + 0x118);     /* PHY config 5 */
    writel(0x20, csi_base + 0x11c);     /* PHY config 6 */
    writel(0x0f, csi_base + 0x120);     /* PHY config 7 */
    writel(0x48, csi_base + 0x124);     /* PHY config 8 */
    writel(0x3f, csi_base + 0x128);     /* PHY config 9 */
    writel(0x0f, csi_base + 0x12c);     /* PHY config 10 */
    writel(0x88, csi_base + 0x130);     /* PHY config 11 */
    wmb();
    
    /* Advanced PHY configuration */
    writel(0x86, csi_base + 0x138);     /* PHY config 12 */
    writel(0x10, csi_base + 0x13c);     /* PHY config 13 */
    writel(0x04, csi_base + 0x140);     /* PHY config 14 */
    writel(0x01, csi_base + 0x144);     /* PHY config 15 */
    writel(0x32, csi_base + 0x148);     /* PHY config 16 */
    writel(0x80, csi_base + 0x14c);     /* PHY config 17 */
    wmb();
    
    /* Timing-critical registers */
    writel(0x01, csi_base + 0x158);     /* Timing config 1 */
    writel(0x60, csi_base + 0x15c);     /* Timing config 2 */
    writel(0x1b, csi_base + 0x160);     /* Timing config 3 */
    writel(0x18, csi_base + 0x164);     /* Timing config 4 */
    writel(0x7f, csi_base + 0x168);     /* Timing config 5 */
    writel(0x4b, csi_base + 0x16c);     /* Timing config 6 */
    writel(0x03, csi_base + 0x174);     /* Timing config 7 */
    wmb();
    
    /* Secondary PHY configuration (lane 1) */
    writel(0x8a, csi_base + 0x180);     /* Lane 1 PHY config base */
    writel(0x05, csi_base + 0x184);     /* Lane 1 PHY config 1 */
    writel(0x40, csi_base + 0x18c);     /* Lane 1 PHY config 2 */
    writel(0xb0, csi_base + 0x190);     /* Lane 1 PHY config 3 */
    writel(0xc5, csi_base + 0x194);     /* Lane 1 PHY config 4 */
    writel(0x03, csi_base + 0x198);     /* Lane 1 PHY config 5 */
    writel(0x09, csi_base + 0x19c);     /* Lane 1 PHY config 6 */
    writel(0x0f, csi_base + 0x1a0);     /* Lane 1 PHY config 7 */
    writel(0x48, csi_base + 0x1a4);     /* Lane 1 PHY config 8 */
    writel(0x0f, csi_base + 0x1a8);     /* Lane 1 PHY config 9 */
    writel(0x0f, csi_base + 0x1ac);     /* Lane 1 PHY config 10 */
    writel(0x88, csi_base + 0x1b0);     /* Lane 1 PHY config 11 */
    wmb();
    
    /* Lane 1 timing configuration */
    writel(0x86, csi_base + 0x1b8);     /* Lane 1 timing 1 */
    writel(0x10, csi_base + 0x1bc);     /* Lane 1 timing 2 */
    writel(0x04, csi_base + 0x1c0);     /* Lane 1 timing 3 */
    writel(0x01, csi_base + 0x1c4);     /* Lane 1 timing 4 */
    writel(0x32, csi_base + 0x1c8);     /* Lane 1 timing 5 */
    writel(0x80, csi_base + 0x1cc);     /* Lane 1 timing 6 */
    writel(0x2b, csi_base + 0x1d0);     /* Lane 1 timing 7 */
    writel(0x22, csi_base + 0x1d4);     /* Lane 1 timing 8 */
    wmb();
    
    /* Final lane 1 configuration */
    writel(0x01, csi_base + 0x1d8);     /* Lane 1 enable */
    writel(0x60, csi_base + 0x1dc);     /* Lane 1 config 1 */
    writel(0x1b, csi_base + 0x1e0);     /* Lane 1 config 2 */
    writel(0x18, csi_base + 0x1e4);     /* Lane 1 config 3 */
    writel(0x7f, csi_base + 0x1e8);     /* Lane 1 config 4 */
    writel(0x4b, csi_base + 0x1ec);     /* Lane 1 config 5 */
    writel(0x03, csi_base + 0x1f4);     /* Lane 1 final config */
    wmb();
    
    private_msleep(10); /* Allow configuration to settle */
    
    /* STEP 3: CSI Lane Config configuration (0x200-0x2ff range) */
    pr_info("Step 3: CSI Lane Config configuration\n");
    
    /* Lane 2 configuration (if 2+ lanes) */
    if (lanes >= 2) {
        writel(0x8a, csi_base + 0x200);     /* Lane 2 PHY config base */
        writel(0x05, csi_base + 0x204);     /* Lane 2 PHY config 1 */
        writel(0x40, csi_base + 0x20c);     /* Lane 2 PHY config 2 */
        writel(0xb0, csi_base + 0x210);     /* Lane 2 PHY config 3 */
        writel(0xc5, csi_base + 0x214);     /* Lane 2 PHY config 4 */
        writel(0x03, csi_base + 0x218);     /* Lane 2 PHY config 5 */
        writel(0x09, csi_base + 0x21c);     /* Lane 2 PHY config 6 */
        writel(0x0f, csi_base + 0x220);     /* Lane 2 PHY config 7 */
        writel(0x48, csi_base + 0x224);     /* Lane 2 PHY config 8 */
        writel(0x0f, csi_base + 0x228);     /* Lane 2 PHY config 9 */
        writel(0x0f, csi_base + 0x22c);     /* Lane 2 PHY config 10 */
        writel(0x88, csi_base + 0x230);     /* Lane 2 PHY config 11 */
        wmb();
        
        /* Lane 2 timing configuration */
        writel(0x86, csi_base + 0x238);     /* Lane 2 timing 1 */
        writel(0x10, csi_base + 0x23c);     /* Lane 2 timing 2 */
        writel(0x04, csi_base + 0x240);     /* Lane 2 timing 3 */
        writel(0x01, csi_base + 0x244);     /* Lane 2 timing 4 */
        writel(0x32, csi_base + 0x248);     /* Lane 2 timing 5 */
        writel(0x80, csi_base + 0x24c);     /* Lane 2 timing 6 */
        writel(0x60, csi_base + 0x250);     /* Lane 2 timing 7 */
        writel(0x22, csi_base + 0x254);     /* Lane 2 timing 8 */
        wmb();
        
        /* Final lane 2 configuration */
        writel(0x01, csi_base + 0x258);     /* Lane 2 enable */
        writel(0x60, csi_base + 0x25c);     /* Lane 2 config 1 */
        writel(0x1b, csi_base + 0x260);     /* Lane 2 config 2 */
        writel(0x18, csi_base + 0x264);     /* Lane 2 config 3 */
        writel(0x7f, csi_base + 0x268);     /* Lane 2 config 4 */
        writel(0x4b, csi_base + 0x26c);     /* Lane 2 config 5 */
        writel(0x03, csi_base + 0x274);     /* Lane 2 final config */
        wmb();
    }
    
    /* Lane 3 configuration (if 3+ lanes) */
    if (lanes >= 3) {
        writel(0x8a, csi_base + 0x280);     /* Lane 3 PHY config base */
        writel(0x05, csi_base + 0x284);     /* Lane 3 PHY config 1 */
        writel(0x40, csi_base + 0x28c);     /* Lane 3 PHY config 2 */
        writel(0xb0, csi_base + 0x290);     /* Lane 3 PHY config 3 */
        writel(0xc5, csi_base + 0x294);     /* Lane 3 PHY config 4 */
        writel(0x03, csi_base + 0x298);     /* Lane 3 PHY config 5 */
        writel(0x09, csi_base + 0x29c);     /* Lane 3 PHY config 6 */
        writel(0x0f, csi_base + 0x2a0);     /* Lane 3 PHY config 7 */
        writel(0x48, csi_base + 0x2a4);     /* Lane 3 PHY config 8 */
        writel(0x0f, csi_base + 0x2a8);     /* Lane 3 PHY config 9 */
        writel(0x0f, csi_base + 0x2ac);     /* Lane 3 PHY config 10 */
        writel(0x88, csi_base + 0x2b0);     /* Lane 3 PHY config 11 */
        wmb();
        
        /* Lane 3 timing configuration */
        writel(0x86, csi_base + 0x2b8);     /* Lane 3 timing 1 */
        writel(0x10, csi_base + 0x2bc);     /* Lane 3 timing 2 */
        writel(0x04, csi_base + 0x2c0);     /* Lane 3 timing 3 */
        writel(0x01, csi_base + 0x2c4);     /* Lane 3 timing 4 */
        writel(0x32, csi_base + 0x2c8);     /* Lane 3 timing 5 */
        writel(0x80, csi_base + 0x2cc);     /* Lane 3 timing 6 */
        wmb();
        
        /* Final lane 3 configuration */
        writel(0x01, csi_base + 0x2d8);     /* Lane 3 enable */
        writel(0x60, csi_base + 0x2dc);     /* Lane 3 config 1 */
        writel(0x1b, csi_base + 0x2e0);     /* Lane 3 config 2 */
        writel(0x18, csi_base + 0x2e4);     /* Lane 3 config 3 */
        writel(0x7f, csi_base + 0x2e8);     /* Lane 3 config 4 */
        writel(0x4b, csi_base + 0x2ec);     /* Lane 3 config 5 */
        writel(0x03, csi_base + 0x2f4);     /* Lane 3 final config */
        wmb();
    }
    
    private_msleep(20); /* Allow full configuration to settle */
    
    pr_info("=== POST-STREAMING CSI CONFIGURATION COMPLETE ===\n");
    pr_info("Configured %d lanes with comprehensive PHY, Config, and Lane settings\n", lanes);
