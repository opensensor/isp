...

{
    ...
    int32_t var_bc_1;
    int32_t var_b8_1;
        char* $t6_1 = (char*)(arg8 + 0x10); // Fixed void pointer assignment
    ...
    while ($s7 != $v0_12)
    {
        ...
        while ($t8_1 != $v0_11)
        {
            *$t5_1 = $lo_1;
            *arg21 += $lo_1;
            $hi_2 = HIGHD(COMBINE($a0_2 % $v0_30, var_c4_1) + $a0_2 * $a1_4);
            $lo_3 = LOWD(COMBINE($a0_2 % $v0_30, var_c4_1) + $a0_2 * $a1_4);
            var_c4_1 = $lo_3;
            $hi_3 = HIGHD(COMBINE($hi_2, var_c0_1) + $v0_30 * $a1_4);
            $lo_5 = LOWD(COMBINE($hi_2, var_c0_1) + $v0_30 * $a1_4);
            var_c0_1 = $lo_5;
            $hi_4 = HIGHD(COMBINE($hi_3, var_bc_1) + $a0_2 * $a1_6);
            $lo_7 = LOWD(COMBINE($hi_3, var_bc_1) + $a0_2 * $a1_6);
            var_bc_1 = $lo_7;
            $hi_5 = HIGHD(COMBINE($hi_4, var_b8_1) + $v0_30 * $a1_6);
            $lo_9 = LOWD(COMBINE($hi_4, var_b8_1) + $v0_30 * $a1_6);
            var_b8_1 = $lo_9;
            ...
            if (*(arg10 + 0x24) && $v1_2 != 1)
                $v0_42 = ((var_58 + 0xfd4)($s2, 
                    (var_60 - 0x75c)($s2, $a1_8, $s3_2, $v0_13 + 1, arg14, arg15)
                        + (var_60 - 0x75c)($s2, $s0_3, $s3_2, $v1 - 1 - $v0_13, arg14, arg15)
                        + (var_60 - 0x75c)($s2, $t9_1, $s3_2, 0x100 - $v1, arg14, arg15)) >> ($s2 & 0x1f)
                    >> 2) + 1;
            
            $t8_1 += 1;
            $t7_1 = &$t7_1[1];
            $hi_8 = HIGHD(COMBINE($hi_7, var_cc_1) + $v0_34 * $a0_16 * $v0_42);
            $lo_13 = LOWD(COMBINE($hi_7, var_cc_1) + $v0_34 * $a0_16 * $v0_42);
            $t6_1 += 4;
            var_cc_1 = $lo_13;
            $hi_9 = HIGHD(COMBINE($hi_8, var_c8_1) + $s3_2 * $a0_16 * $v0_42);
            $lo_15 = LOWD(COMBINE($hi_8, var_c8_1) + $s3_2 * $a0_16 * $v0_42);
            $t0_1 = &$t0_1[1];
            $v1_8 = &$v1_8[1];
            var_c8_1 = $lo_15;
            $fp_1 = &$fp_1[1];
    ...
    __private_spin_lock_irqsave(0, &var_e0_1);
    memcpy(arg7, arg6, 0x384);
    private_spin_unlock_irqrestore(0, var_e0_2);
    *arg22 = var_c4_1_3 / var_c0_1_3;
    *arg23 = var_bc_1_3 / var_b8_1_3;
    uint32_t $v0_66 = var_cc_1_1 / var_c8_1;
    
    if (!$v0_66)
        $v0_66 = 1;
    
    *arg19 = $v0_66;
    int32_t $s0_5 = var_d0_1_1 << ($s2 & 0x1f);
    *arg20 = fix_point_div_32($s2, var_d8_1 << ($s2 & 0x1f), $s0_5);
    int32_t result = fix_point_div_32($s2, var_d4_1 << ($s2 & 0x1f), $s0_5);
    arg20[1] = result;
    return result;
}
