    ...
    *arg23 = $v1_53;
    ...
    if ($a0_27 < $s6)
    {
        ...
        if ($a1_11 >= $s6)
        {
            ...
            var_120_7 = ($lo_22 << 2) * $a1_5 + ((($lo_49 + $a3_56 / 2) / $a3_56) << 9);
            $a0_42 = $a1_10;
        }
        else if ($a1_12 < $s6)
            $a0_42 = $a1_10;
        ...
        {
            var_120_8 = ($a1_9 << 2) * $lo_22 + ((($s6 - $a1_7 + $a1_8 / 2) / $a1_8 + $a1_6) << 9);
            $a0_42 = $a1_10;
        }
    }
    else
    ...
    else
    {
        ...
        int32_t $t4_32 = *arg7;
        int32_t $a1_73 = ($lo_61 / $a1_10 + var_120_10 + 0x40) / 0x80;
