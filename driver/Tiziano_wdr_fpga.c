...

{
    ...
    claHistG1 = *arg20;
    data_aa51c_1 = *arg21;
    int32_t* $v0_14 = &data_aa51c_2;
    int32_t* var_114_3 = &claHistG0;
    int32_t* $t5 = &claHistG0;
    int32_t* $t1 = &data_aa51c_3;
    int32_t* $t3 = &claHistR1;
    int32_t* $t4 = &claHistB0;
    
    for (int32_t i = 0; i != 0x3fc; )
    {
        int32_t $a2_2 = *$t6;
        $t6 = &$t6[1];
        *$t6 = *(arg16 + i + 4) + $a2_2;
    ...
    void* var_34_18 = &data_b0000_10;
    void* var_ec_1 = &data_a9d1c;
    int32_t* var_30_10 = &data_a911c_1;
    int32_t $a0_4 = $a3_14;
    ...
    if ($a0_4)
    {
        int32_t* $t3_2 = &data_a911c_2;
        int32_t* $t7_1 = &claHistR0;
        
        for (int32_t i_1 = 0; i_1 != 0x100; )
        {
            int32_t $t1_7 = *$t7_1;
            int32_t $t0_10 = *$v1_13;
            i_1 += 1;
        ...
        for (int32_t* i_3 = nullptr; i_3 != 0x100; )
        {
            int32_t $a3_33 = *$t3_7;
            int32_t $a2_15 = *$v0_14;
            i_3 += 1;
    ...
    {
        void* $t0_1 = &data_a9d1c_2;
        int32_t* $t3_1 = &data_a911c_3;
    ...
    int32_t var_158_2;
    tx_isp_module_deinit(&var_158_3, arg29, &data_a911c_4, j_2);
    void* var_a0_1_3 = &data_b0000_11;
    int32_t var_164_10;
    tx_isp_module_deinit(&var_164_11, arg29, &data_a8d1c_2);
    void* var_114_1_8 = &data_b0000_12;
    int32_t var_170;
    tx_isp_module_deinit(&var_170_2, arg29, &data_a951c_2, &data_b0000_13);
    *arg30 = var_158_4;
    int32_t var_154;
    arg30[1] = var_154_1;
    int32_t var_150;
    ...
    do
    {
        var_114_2_2 = &data_a8bd8;
        *(&data_a8bd8_1 + i_4) = *(arg22 + i_4);
        *(&data_a8950 + i_4) = *(arg24 + i_4);
        int32_t $t2_20 = *(arg23 + i_4);
        void* $t1_23 = &data_a8a94 + i_4;
        i_4 += 4;
        *$t1_23 = $t2_20;
        var_fc_1_1 = &data_a8950_1;
        var_a0_2_8 = &data_a8a94_1;
    } while (i_4 != 0x144);
    
    int32_t* $s2_1 = &data_a911c_5;
    arg22[1] = data_a911c_6;
    void* $v1_26 = var_a0_1_4 - 0x72e4;
    arg24[1] = *(var_a0_1_5 - 0x72e4);
    void* $v0_17 = var_114_1_9 - 0x6ae4;
    arg23[1] = *(var_114_1_10 - 0x6ae4);
    void* $a3_36 = &arg22[2];
    void* $a2_16 = &arg24[2];
    void* $a1_23 = &arg23[2];
    void* $t1_24 = $v0_17;
    void* $t2_21 = $v1_26;
    int32_t* $t3_8 = &data_a911c_7;
    int32_t $t0_15 = 0;
    int32_t i_5 = 1;
    void* $t6_7 = $v1_26;
    void* $ra = $v0_17;
    ...
    int32_t $lo = (getVar(var_34_19 - 0x62e4) + getVar(&data_a991c_2) + getVar(&data_aa11c_2)) / 3;
    int32_t $a3_37 = 0;
    int32_t $a0_17;
    ...
    else
    {
        ...
        else
        {
            ...
            for (int32_t i_6 = 0; i_6 != 0x140; )
            {
                ...
                int32_t $lo_6;
                int32_t $hi_5;
                $hi_5 = HIGHD(COMBINE($hi_4, $lo_5) + $a3_37 * *(var_114_2_3 + i_6 + 4));
                $lo_6 = LOWD(COMBINE($hi_4, $lo_5) + $a3_37 * *(var_114_2_4 + i_6 + 4));
                $t0_17 += 4;
                $a2_18 += 4;
                *($t1_25 - 4) = ($lo_6 + 8) / 0x10;
                int32_t $lo_9;
                int32_t $hi_7;
                $hi_7 = HIGHD((0x10 - $a3_37) * *($t0_17 - 4) + $a3_37 * *(var_fc_1_2 + i_6 + 4));
                $lo_9 = LOWD((0x10 - $a3_37) * *($t0_17 - 4) + $a3_37 * *(var_fc_1_3 + i_6 + 4));
                *($t0_17 - 4) = ($lo_9 + 8) / 0x10;
                int32_t $v1_44 = *(var_a0_2_9 + i_6 + 4);
                i_6 += 4;
                int32_t $lo_12;
                int32_t $hi_9;
    ...
    else
    {
        ...
        else
        {
            ...
            if ($lo < $v1_49)
            {
                ...
                var_110_1_1 = ($lo_15 + $v1_50 / 2) / $v1_50;
            }
    ...
    *arg23 = $v1_53;
    ...
    while ($t1_26 < $a3_18)
    {
        ...
        int32_t $v1_65 = *(var_114_3_2 + $t8_22);
        int32_t $lo_28;
        int32_t $hi_22;
    ...
    if ($a0_27 < $s6)
    {
        ...
        if ($a1_11 >= $s6)
        {
            ...
            var_120_11 = ($lo_22 << 2) * $a1_5 + ((($lo_49 + $a3_56 / 2) / $a3_56) << 9);
            $a0_42 = $a1_10;
        }
        else if ($a1_12 < $s6)
            $a0_42 = $a1_10;
        ...
        {
            var_120_12 = ($a1_9 << 2) * $lo_22 + ((($s6 - $a1_7 + $a1_8 / 2) / $a1_8 + $a1_6) << 9);
            $a0_42 = $a1_10;
        }
    }
    else
    ...
    {
        void var_1d8_10;
        void* $a1_68 = &var_1d8_11;
        int32_t* i_19 = arg25 + 4;
        void* $a3_59 = &var_1d8_12;
        int32_t* i_7 = i_19;
        ...
        int32_t $t4_32 = *arg7;
        int32_t $a1_73 = ($lo_61 / $a1_10 + var_120_14 + 0x40) / 0x80;
        ...
        if ($a3_29 >= $lo_22)
        {
            ...
            var_134_1_2 = $a2_1 + (($a2 < $lo_22 ? 1 : 0) < 1 ? 1 : 0);
        ...
        if ($a3_23)
        {
            ...
            int32_t $a3_71 = (1 - var_134_1_3) * $v1_1;
            int32_t $t0_47 = $a3_24;
        ...
        else
        {
            ...
            if (var_124_16 < $a1)
            {
                ...
                do
                {
                    ...
                    int32_t $lo_73;
                    int32_t $hi_59;
                    $hi_59 = HIGHD($v0_102 * $a2_32 + (*i_17 - $v0_102) * (var_124_17 - $a3_19));
                    $lo_73 = LOWD($v0_102 * $a2_32 + (*i_17 - $v0_102) * (var_124_18 - $a3_19));
                    i_17 = &i_17[1];
                    $t0_61 = &$t0_61[1];
                    $a3_75 = &$a3_75[1];
