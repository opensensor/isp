    ...
    else
    {
        ...
        if ((uintptr_t)arg2 < 0xc0445610)
        {
            ...
            while (true)
            {
                ...
                if (!$v0_64)
                {
                    isp_printf(); // Fixed: macro with no parameters, removed 2 arguments,STATE(%d),%d", $a2_8);
                    break;
                }
            ...
            int32_t $a2_10 = isp_printf(); // Fixed: macro with no parameters, removed 3 arguments;
