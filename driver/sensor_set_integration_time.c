...

{
    ...
    if ($a0 != *($v1 + 0xac))
    {
        *((int32_t*)((char*)$v1 + 0xec)) = (0xffff0000 & *($v1 + 0xec)) + $a0; // Fixed void pointer dereference
        *((int32_t*)((char*)$v1 + 0xac)) = $a0; // Fixed void pointer dereference
        *((int32_t*)((char*)ispcore_1 + 0x198)) = 1; // Fixed void pointer dereference
        *((int32_t*)((char*)ispcore_1 + 0x19c)) = $a0; // Fixed void pointer dereference
