...

{
    if (ev_changed == 1)
    {
        ...
        while (true)
        {
            ...
            if ($s4_1 < ev_now_1)
            {
                ...
                {
                    **&adr_map_mode_now = data_af7cc_1;
                    void* adr_map_mode_now_2 = adr_map_mode_now;
                    *(adr_map_mode_now_2 + 8) = data_af800_1;
                    *(adr_map_mode_now_2 + 0x14) = *(adr_blp2_list_now + 0x20);
                    *(adr_light_end_now + 0x70) = *(adr_ligb_list_now + 0x20);
                    adr_block_light_now_1 = adr_block_light_now;
                    *(adr_block_light_now_1 + 0x28) = *(adr_mapb1_list_now + 0x20);
                    *(adr_block_light_now_1 + 0x2c) = *(adr_mapb2_list_now + 0x20);
                    *(adr_block_light_now_1 + 0x30) = *(adr_mapb3_list_now + 0x20);
            ...
            else
            {
                if ($a3_1)
                {
                    ...
                    if ($s4_1 != $a2_2)
                    {
                        ...
                        *(adr_block_light_now_4 + 0x28) = $a2_27;
                        ...
                        *(adr_block_light_now_4 + 0x2c) = $a2_30;
                        ...
                        *(adr_block_light_now_4 + 0x30) = $a2_33;
                        ...
                        *(adr_block_light_now_4 + 0x34) = $a2_36;
                    }
                    else
                    {
                        **&adr_map_mode_now =
                        ...
                        *(adr_map_mode_now_3 + 0x14) = *(adr_blp2_list_now + $v1_1);
                        *(adr_light_end_now + 0x70) = *(adr_ligb_list_now + $v1_1);
                        void* adr_block_light_now_2 = adr_block_light_now;
                        *(adr_block_light_now_2 + 0x28) = *(adr_mapb1_list_now + $v1_1);
                        *(adr_block_light_now_2 + 0x2c) = *(adr_mapb2_list_now + $v1_1);
                        *(adr_block_light_now_2 + 0x30) = *(adr_mapb3_list_now + $v1_1);
                        *(adr_block_light_now_2 + 0x34) = *(adr_mapb4_list_now + $v1_1);
                    }
                ...
                *(adr_map_mode_now_1 + 8) = data_af7e0_1;
                *(adr_map_mode_now_1 + 0x14) = **&adr_blp2_list_now;
                *(adr_light_end_now + 0x70) = **&adr_ligb_list_now;
                adr_block_light_now_1 = adr_block_light_now;
                *(adr_block_light_now_1 + 0x28) = **&adr_mapb1_list_now;
                *(adr_block_light_now_1 + 0x2c) = **&adr_mapb2_list_now;
                *(adr_block_light_now_1 + 0x30) = **&adr_mapb3_list_now;
                $a1_13 = **&adr_mapb4_list_now;
            }
            
            *(adr_block_light_now_1 + 0x34) = $a1_13;
            break;
        }
        ...
        if (data_ace5c_1 == 1)
        {
            ...
            if ($t1_41 < ev_now_1)
            {
                ...
                if ($t2_9 >= ev_now_1)
                {
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_40;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_42;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_44;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_46;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_48;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_50;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_52;
                    $a2_53 = data_af21c_1;
                ...
                if ($t1_42 >= ev_now_1)
                {
                    uint32_t $t4_2 = data_af220_2;
                    uint32_t $a2_54 = data_af234_1;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_61;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_63;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_65;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_67;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_69;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_71;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_73;
                    $a2_53 = data_af230_2;
                ...
                if ($t2_39 >= ev_now_1)
                {
                    uint32_t $t4_3 = data_af234_2;
                    uint32_t $a3_187 = data_af24c_1;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_77;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_79;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_81;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_83;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_85;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_87;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_89;
                    $a2_53 = data_af244_2;
                ...
                if ($t1_106 >= ev_now_1)
                {
                    uint32_t $t4_4 = data_af24c_2;
                    uint32_t $a2_90 = data_af25c_2[4][0];
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_93;
                    ...
                    uint32_t $a3_248 = data_af25c_3[6][0];
                    adr_ctc_map2cut_y_now_2 = adr_ctc_map2cut_y_now;
                    uint32_t $a2_97;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_97;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_99;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_101;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_103;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_105;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_107;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_109;
                    $a2_53 = data_af25c_4[0];
                ...
                if ($t2_96 >= ev_now_1)
                {
                    uint32_t $t4_5 = data_af25c_5[4][0];
                    uint32_t $a3_301 = data_af26e_3[6][0];
                    ...
                    **&adr_ctc_map2cut_y_now = $a3_304;
                    uint32_t $a2_112 = data_af25c_6[6][0];
                    uint32_t $a3_307 = data_af26e_4[8][0];
                    adr_ctc_map2cut_y_now_2 = adr_ctc_map2cut_y_now;
                    uint32_t $a2_113;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_113;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_115;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_117;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_119;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_121;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_123;
                    uint32_t $a2_124 = data_af26e_5[0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_125;
                    $a2_53 = data_af26e_6[2][0];
                ...
                if ($t1_171 >= ev_now_1)
                {
                    uint32_t $t4_6 = data_af26e_7[6][0];
                    uint32_t $a2_126 = data_af28c_1;
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_129;
                    uint32_t $a2_132 = data_af26e_8[8][0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_133;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_135;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_137;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_139;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_141;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_143;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_145;
                    $a2_53 = data_af284_2;
                ...
                if ($t2_153 >= ev_now_1)
                {
                    uint32_t $t4_7 = data_af28c_2;
                    uint32_t $a3_415 = data_af2a0_1;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_149;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_151;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_153;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_155;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_157;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_159;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_161;
                    $a2_53 = data_af29c_2;
                ...
                if ($t3_205 < ev_now_1)
                {
                    **&adr_ctc_map2cut_y_now = data_af2b4_1;
                    adr_ctc_map2cut_y_now_1 = adr_ctc_map2cut_y_now;
                    *(adr_ctc_map2cut_y_now_1 + 4) = data_af2b6_1;
                    *(adr_ctc_map2cut_y_now_1 + 8) = data_af2b8_1[0];
                    *(adr_ctc_map2cut_y_now_1 + 0xc) = data_af2b8_2[2][0];
                    *(adr_ctc_map2cut_y_now_1 + 0x10) = data_af2b8_3[4][0];
                    *(adr_ctc_map2cut_y_now_1 + 0x14) = data_af2b8_4[6][0];
                    *(adr_ctc_map2cut_y_now_1 + 0x18) = data_af2b8_5[8][0];
                    *(adr_ctc_map2cut_y_now_1 + 0x1c) = data_af2c2_1;
                    *(adr_ctc_map2cut_y_now_1 + 0x20) = data_af2c4_1;
                }
                else
                {
                    uint32_t $t4_8 = data_af2a0_2;
                    uint32_t $a2_163 = data_af2b4_2;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 4) = $a2_170;
                    uint32_t $a2_171 = data_af2a4_2;
                    uint32_t $a3_485 = data_af2b8_6[0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 8) = $a2_172;
                    uint32_t $a2_173 = data_af2a6_2;
                    uint32_t $a3_492 = data_af2b8_7[2][0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0xc) = $a2_174;
                    uint32_t $a2_175 = data_af2a8_2;
                    uint32_t $a3_499 = data_af2b8_8[4][0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x10) = $a2_176;
                    uint32_t $a2_177 = data_af2aa_2;
                    uint32_t $a3_506 = data_af2b8_9[6][0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x14) = $a2_178;
                    uint32_t $a2_179 = data_af2ac_2;
                    uint32_t $a3_513 = data_af2b8_10[8][0];
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x18) = $a2_180;
                    uint32_t $a2_181 = data_af2ae_2;
                    uint32_t $a3_520 = data_af2c2_2;
                    ...
                    *(adr_ctc_map2cut_y_now_2 + 0x1c) = $a2_182;
                    $a2_53 = data_af2b0_2;
                    uint32_t $v1_38 = data_af2c4_2;
                    ...
                    label_5a5fc:
                        ...
                        *(adr_ctc_map2cut_y_now_2 + 0x20) = $v0_20 / $a0_13 + $a2_53;
                    }
                    else
                    {
                    ...
                    label_5a5bc:
                        ...
                        *(adr_ctc_map2cut_y_now_2 + 0x20) = $a2_53 - $v0_17 / $a0_12;
                    }
                }
            }
            else
            {
                **&adr_ctc_map2cut_y_now = param_adr_gam_y_array;
                adr_ctc_map2cut_y_now_1 = adr_ctc_map2cut_y_now;
                *(adr_ctc_map2cut_y_now_1 + 4) = data_af20e_2;
                *(adr_ctc_map2cut_y_now_1 + 8) = data_af210_2;
                *(adr_ctc_map2cut_y_now_1 + 0xc) = data_af212_2;
                *(adr_ctc_map2cut_y_now_1 + 0x10) = data_af214_2;
                *(adr_ctc_map2cut_y_now_1 + 0x14) = data_af216_2;
                *(adr_ctc_map2cut_y_now_1 + 0x18) = data_af218_2;
                *(adr_ctc_map2cut_y_now_1 + 0x1c) = data_af21a_2;
                *(adr_ctc_map2cut_y_now_1 + 0x20) = data_af21c_2;
            }
        }
    }
    ...
    for (int32_t i_1 = 0; i_1 < 0x30; i_1 += 1)
    {
        char var_58_16[0x34];
        var_58_17[i_1] = *(&data_d03e8_2 + i_1);
    }
    ...
    if ($t7_7 == 1)
    {
        int32_t $t0_354 = data_ace84_1;
        int32_t $s0_5 = data_ace7c_1;
        ...
        do
        {
            ...
            if (!$v1_44)
            {
                for (int32_t j_1 = 0xff5; j_1 != 0x1000; )
                {
                    if (j_1 < *$v1_50)
                        *$v1_50 = j_1;
            ...
            else
            {
                ...
                for (int32_t j_2 = 0xff5; j_2 != 0x1000; )
                {
