...
{
        char* adr_ev_list_now_1 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
        uint32_t ev_now_1 = ev_now;
        char* adr_ev_list_now_85 = (char*)(adr_ev_list_now_1); // Fixed void pointer assignment
        int32_t $a3_1 = 0;
            int32_t $s4_1 = *adr_ev_list_now_85;
            int32_t $v1_1 = $a3_1 << 2;
            void* adr_block_light_now_1;
            int32_t $a1_13;
                    char* adr_map_mode_now_2 = (char*)(adr_map_mode_now); // Fixed void pointer assignment
    if (ev_changed == 1)
    {
        ev_changed = 0;
        ...
        while (true)
        {
            ...
            if ($s4_1 < ev_now_1)
            {
                ...
                else
                {
                    ...
                    *((int32_t*)((char*)adr_map_mode_now_2 + 8)) = data_af800; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_map_mode_now_2 + 0x14)) = *(adr_blp2_list_now + 0x20); // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_light_end_now + 0x70)) = *(adr_ligb_list_now + 0x20); // Fixed void pointer dereference
                    adr_block_light_now_1 = adr_block_light_now;
                    *((int32_t*)((char*)adr_block_light_now_1 + 0x28)) = *(adr_mapb1_list_now + 0x20); // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_block_light_now_1 + 0x2c)) = *(adr_mapb2_list_now + 0x20); // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_block_light_now_1 + 0x30)) = *(adr_mapb3_list_now + 0x20); // Fixed void pointer dereference
            ...
            else
            {
                ...
                if ($a3_1)
                {
                    ...
                    if ($s4_1 != $a2_2)
                    {
                        ...
                        **&adr_map_mode_now = $t1_11;
                        ...
                        char* adr_map_mode_now_4 = (char*)(adr_map_mode_now); // Fixed void pointer assignment
                        int32_t $a2_18;
                        
                        if ($a3_5 >= $a2_17)
                        {
                            char* adr_ev_list_now_80 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        {
                            char* adr_ev_list_now_79 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        char* adr_blp2_list_now_1 = (char*)(adr_blp2_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_map_mode_now_4 + 8)) = $a2_18; // Fixed void pointer dereference
                        int32_t $a2_20 = *(adr_blp2_list_now_1 + ($a3_1 << 2) - 4);
                        int32_t $a3_15 = *(adr_blp2_list_now_1 + $v1_1);
                        char* adr_ev_list_now_78 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        int32_t $a2_21;
                        ...
                        char* adr_ligb_list_now_1 = (char*)(adr_ligb_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_map_mode_now_4 + 0x14)) = $a2_21; // Fixed void pointer dereference
                        ...
                        if ($a3_25 >= $a2_23)
                        {
                            char* adr_ev_list_now_84 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        {
                            char* adr_ev_list_now_83 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        char* adr_mapb1_list_now_1 = (char*)(adr_mapb1_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_light_end_now + 0x70)) = $a2_24; // Fixed void pointer dereference
                        int32_t $a2_26 = *(adr_mapb1_list_now_1 + ($a3_1 << 2) - 4);
                        int32_t $a3_35 = *(adr_mapb1_list_now_1 + $v1_1);
                        char* adr_block_light_now_4 = (char*)(adr_block_light_now); // Fixed void pointer assignment
                        int32_t $a2_27;
                        
                        if ($a3_35 >= $a2_26)
                        {
                            char* adr_ev_list_now_82 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        {
                            char* adr_ev_list_now_81 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        ...
                        char* adr_mapb2_list_now_1 = (char*)(adr_mapb2_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_block_light_now_4 + 0x28)) = $a2_27; // Fixed void pointer dereference
                        int32_t $a2_29 = *(adr_mapb2_list_now_1 + ($a3_1 << 2) - 4);
                        int32_t $a3_45 = *(adr_mapb2_list_now_1 + $v1_1);
                        char* adr_ev_list_now_77 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        int32_t $a2_30;
                        ...
                        char* adr_mapb3_list_now_1 = (char*)(adr_mapb3_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_block_light_now_4 + 0x2c)) = $a2_30; // Fixed void pointer dereference
                        int32_t $a2_32 = *(adr_mapb3_list_now_1 + ($a3_1 << 2) - 4);
                        int32_t $a3_55 = *(adr_mapb3_list_now_1 + $v1_1);
                        char* adr_ev_list_now_76 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        int32_t $a2_33;
                        ...
                        char* adr_mapb4_list_now_1 = (char*)(adr_mapb4_list_now); // Fixed void pointer assignment
                        *((int32_t*)((char*)adr_block_light_now_4 + 0x30)) = $a2_33; // Fixed void pointer dereference
                        int32_t $a2_35 = *(adr_mapb4_list_now_1 + ($a3_1 << 2) - 4);
                        int32_t $a3_65 = *(adr_mapb4_list_now_1 + $v1_1);
                        char* adr_ev_list_now_11 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                        int32_t $a2_36;
                        ...
                        *((int32_t*)((char*)adr_block_light_now_4 + 0x34)) = $a2_36; // Fixed void pointer dereference
                    }
                    else
                    {
                        char* adr_map_mode_now_3 = (char*)(adr_map_mode_now); // Fixed void pointer assignment
                        char* adr_block_light_now_2 = (char*)(adr_block_light_now); // Fixed void pointer assignment
                        **&adr_map_mode_now =
                            *(&param_adr_min_kneepoint_array + (($a3_1 + 1) << 2));
                        *(adr_map_mode_now_3 + 8) =
                            *(&param_adr_min_kneepoint_array + (($a3_1 + 0xe) << 2));
                        *((int32_t*)((char*)adr_map_mode_now_3 + 0x14)) = *(adr_blp2_list_now + $v1_1); // Fixed void pointer dereference
                        *((int32_t*)((char*)adr_light_end_now + 0x70)) = *(adr_ligb_list_now + $v1_1); // Fixed void pointer dereference
                        *((int32_t*)((char*)adr_block_light_now_2 + 0x28)) = *(adr_mapb1_list_now + $v1_1); // Fixed void pointer dereference
                        *((int32_t*)((char*)adr_block_light_now_2 + 0x2c)) = *(adr_mapb2_list_now + $v1_1); // Fixed void pointer dereference
                        *((int32_t*)((char*)adr_block_light_now_2 + 0x30)) = *(adr_mapb3_list_now + $v1_1); // Fixed void pointer dereference
                        *((int32_t*)((char*)adr_block_light_now_2 + 0x34)) = *(adr_mapb4_list_now + $v1_1); // Fixed void pointer dereference
                    }
                ...
                **&adr_map_mode_now = data_af7ac_1;
                char* adr_map_mode_now_1 = (char*)(adr_map_mode_now); // Fixed void pointer assignment
                *((int32_t*)((char*)adr_map_mode_now_1 + 8)) = data_af7e0_1; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_map_mode_now_1 + 0x14)) = **&adr_blp2_list_now; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_light_end_now + 0x70)) = **&adr_ligb_list_now; // Fixed void pointer dereference
                adr_block_light_now_1 = adr_block_light_now;
                *((int32_t*)((char*)adr_block_light_now_1 + 0x28)) = **&adr_mapb1_list_now; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_block_light_now_1 + 0x2c)) = **&adr_mapb2_list_now; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_block_light_now_1 + 0x30)) = **&adr_mapb3_list_now; // Fixed void pointer dereference
                $a1_13 = **&adr_mapb4_list_now;
            }
            
            *((int32_t*)((char*)adr_block_light_now_1 + 0x34)) = $a1_13; // Fixed void pointer dereference
            break;
        }
        
        if (data_ace5c_1 == 1)
        {
            char* adr_ev_list_now_2 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
            ...
            if ($t1_41 < ev_now_1)
            {
                ...
                if ($t2_9 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a3_74;
                    ...
                    if ($a3_77 >= $a2_39)
                    {
                        char* adr_ev_list_now_13 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_12 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_40; // Fixed void pointer dereference
                    uint32_t $a2_41 = data_af210_1;
                    uint32_t $a3_84 = data_af224_1;
                    char* adr_ev_list_now_14 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_42;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_42; // Fixed void pointer dereference
                    uint32_t $a2_43 = data_af212_1;
                    uint32_t $a3_91 = data_af226_1;
                    char* adr_ev_list_now_15 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_44;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_44; // Fixed void pointer dereference
                    uint32_t $a2_45 = data_af214_1;
                    uint32_t $a3_98 = data_af228_1;
                    char* adr_ev_list_now_16 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_46;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_46; // Fixed void pointer dereference
                    uint32_t $a2_47 = data_af216_1;
                    uint32_t $a3_105 = data_af22a_1;
                    char* adr_ev_list_now_17 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_48;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_48; // Fixed void pointer dereference
                    uint32_t $a2_49 = data_af218_1;
                    uint32_t $a3_112 = data_af22c_1;
                    char* adr_ev_list_now_18 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_50;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_50; // Fixed void pointer dereference
                    uint32_t $a2_51 = data_af21a_1;
                    uint32_t $a3_119 = data_af22e_1;
                    char* adr_ev_list_now_19 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_52;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_52; // Fixed void pointer dereference
                    $a2_53 = data_af21c_1;
                    uint32_t $v1_17 = data_af230_1;
                    char* adr_ev_list_now_3 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t1_42 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_57;
                    ...
                    if ($a3_134 >= $a2_60)
                    {
                        char* adr_ev_list_now_21 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_20 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_61; // Fixed void pointer dereference
                    uint32_t $a2_62 = data_af224_2;
                    uint32_t $a3_141 = data_af238_1;
                    char* adr_ev_list_now_22 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_63;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_63; // Fixed void pointer dereference
                    uint32_t $a2_64 = data_af226_2;
                    uint32_t $a3_148 = data_af23a_1;
                    char* adr_ev_list_now_23 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_65;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_65; // Fixed void pointer dereference
                    uint32_t $a2_66 = data_af228_2;
                    uint32_t $a3_155 = data_af23c_1;
                    char* adr_ev_list_now_24 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_67;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_67; // Fixed void pointer dereference
                    uint32_t $a2_68 = data_af22a_2;
                    uint32_t $a3_162 = data_af23e_1;
                    char* adr_ev_list_now_25 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_69;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_69; // Fixed void pointer dereference
                    uint32_t $a2_70 = data_af22c_2;
                    uint32_t $a3_169 = data_af240_1;
                    char* adr_ev_list_now_26 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_71;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_71; // Fixed void pointer dereference
                    uint32_t $a2_72 = data_af22e_2;
                    uint32_t $a3_176 = data_af242_1;
                    char* adr_ev_list_now_27 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_73;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_73; // Fixed void pointer dereference
                    $a2_53 = data_af230_2;
                    uint32_t $v1_20 = data_af244_1;
                    char* adr_ev_list_now_4 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t2_39 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a3_190;
                    ...
                    if ($a3_193 >= $a2_76)
                    {
                        char* adr_ev_list_now_29 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_28 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_77; // Fixed void pointer dereference
                    uint32_t $a2_78 = data_af238_2;
                    uint32_t $a3_200 = data_af250_1;
                    char* adr_ev_list_now_30 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_79;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_79; // Fixed void pointer dereference
                    uint32_t $a2_80 = data_af23a_2;
                    uint32_t $a3_207 = data_af252_1;
                    char* adr_ev_list_now_31 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_81;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_81; // Fixed void pointer dereference
                    uint32_t $a2_82 = data_af23c_2;
                    uint32_t $a3_214 = data_af254_1;
                    char* adr_ev_list_now_32 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_83;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_83; // Fixed void pointer dereference
                    uint32_t $a2_84 = data_af23e_2;
                    uint32_t $a3_221 = data_af256_1;
                    char* adr_ev_list_now_33 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_85;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_85; // Fixed void pointer dereference
                    uint32_t $a2_86 = data_af240_2;
                    uint32_t $a3_228 = data_af258_1;
                    char* adr_ev_list_now_34 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_87;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_87; // Fixed void pointer dereference
                    uint32_t $a2_88 = data_af242_2;
                    uint32_t $a3_235 = data_af25a_1;
                    char* adr_ev_list_now_35 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_89;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_89; // Fixed void pointer dereference
                    $a2_53 = data_af244_2;
                    uint32_t $v1_23 = data_af25c_1[0];
                    char* adr_ev_list_now_5 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t1_106 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_93;
                    ...
                    if ($a3_248 >= $a2_96)
                    {
                        char* adr_ev_list_now_37 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_36 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_97; // Fixed void pointer dereference
                    uint32_t $a2_98 = data_af250_2;
                    uint32_t $a3_255 = data_af264_1;
                    char* adr_ev_list_now_38 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_99;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_99; // Fixed void pointer dereference
                    uint32_t $a2_100 = data_af252_2;
                    uint32_t $a3_262 = data_af266_1;
                    char* adr_ev_list_now_39 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_101;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_101; // Fixed void pointer dereference
                    uint32_t $a2_102 = data_af254_2;
                    uint32_t $a3_269 = data_af268_1;
                    char* adr_ev_list_now_40 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_103;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_103; // Fixed void pointer dereference
                    uint32_t $a2_104 = data_af256_2;
                    uint32_t $a3_276 = data_af26a_1;
                    char* adr_ev_list_now_41 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_105;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_105; // Fixed void pointer dereference
                    uint32_t $a2_106 = data_af258_2;
                    uint32_t $a3_283 = data_af26c_1;
                    char* adr_ev_list_now_42 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_107;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_107; // Fixed void pointer dereference
                    uint32_t $a2_108 = data_af25a_2;
                    uint32_t $a3_290 = data_af26e_1[0];
                    char* adr_ev_list_now_43 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_109;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_109; // Fixed void pointer dereference
                    $a2_53 = data_af25c_3[0];
                    uint32_t $v1_26 = data_af26e_2[2][0];
                    char* adr_ev_list_now_6 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t2_96 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a3_304;
                    ...
                    if ($a3_307 >= $a2_112)
                    {
                        char* adr_ev_list_now_45 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_44 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_113; // Fixed void pointer dereference
                    uint32_t $a2_114 = data_af264_2;
                    uint32_t $a3_314 = data_af278_1;
                    char* adr_ev_list_now_46 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_115;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_115; // Fixed void pointer dereference
                    uint32_t $a2_116 = data_af266_2;
                    uint32_t $a3_321 = data_af27a_1;
                    char* adr_ev_list_now_47 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_117;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_117; // Fixed void pointer dereference
                    uint32_t $a2_118 = data_af268_2;
                    uint32_t $a3_328 = data_af27c_1;
                    char* adr_ev_list_now_48 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_119;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_119; // Fixed void pointer dereference
                    uint32_t $a2_120 = data_af26a_2;
                    uint32_t $a3_335 = data_af27e_1;
                    char* adr_ev_list_now_49 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_121;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_121; // Fixed void pointer dereference
                    uint32_t $a2_122 = data_af26c_2;
                    uint32_t $a3_342 = data_af280_1;
                    char* adr_ev_list_now_50 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_123;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_123; // Fixed void pointer dereference
                    uint32_t $a2_124 = data_af26e_4[0];
                    uint32_t $a3_349 = data_af282_1;
                    char* adr_ev_list_now_51 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_125;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_125; // Fixed void pointer dereference
                    $a2_53 = data_af26e_5[2][0];
                    uint32_t $v1_29 = data_af284_1;
                    char* adr_ev_list_now_7 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t1_171 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_129;
                    ...
                    if ($a3_362 >= $a2_132)
                    {
                        char* adr_ev_list_now_53 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_52 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_133; // Fixed void pointer dereference
                    uint32_t $a2_134 = data_af278_2;
                    uint32_t $a3_369 = data_af290_1;
                    char* adr_ev_list_now_54 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_135;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_135; // Fixed void pointer dereference
                    uint32_t $a2_136 = data_af27a_2;
                    uint32_t $a3_376 = data_af292_1;
                    char* adr_ev_list_now_55 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_137;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_137; // Fixed void pointer dereference
                    uint32_t $a2_138 = data_af27c_2;
                    uint32_t $a3_383 = data_af294_1;
                    char* adr_ev_list_now_56 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_139;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_139; // Fixed void pointer dereference
                    uint32_t $a2_140 = data_af27e_2;
                    uint32_t $a3_390 = data_af296_1;
                    char* adr_ev_list_now_57 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_141;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_141; // Fixed void pointer dereference
                    uint32_t $a2_142 = data_af280_2;
                    uint32_t $a3_397 = data_af298_1;
                    char* adr_ev_list_now_58 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_143;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_143; // Fixed void pointer dereference
                    uint32_t $a2_144 = data_af282_2;
                    uint32_t $a3_404 = data_af29a_1;
                    char* adr_ev_list_now_59 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_145;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_145; // Fixed void pointer dereference
                    $a2_53 = data_af284_2;
                    uint32_t $v1_32 = data_af29c_1;
                    char* adr_ev_list_now_8 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t2_153 >= ev_now_1)
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a3_418;
                    ...
                    if ($a3_421 >= $a2_148)
                    {
                        char* adr_ev_list_now_61 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_60 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_149; // Fixed void pointer dereference
                    uint32_t $a2_150 = data_af290_2;
                    uint32_t $a3_428 = data_af2a4_1;
                    char* adr_ev_list_now_62 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_151;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_151; // Fixed void pointer dereference
                    uint32_t $a2_152 = data_af292_2;
                    uint32_t $a3_435 = data_af2a6_1;
                    char* adr_ev_list_now_63 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_153;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_153; // Fixed void pointer dereference
                    uint32_t $a2_154 = data_af294_2;
                    uint32_t $a3_442 = data_af2a8_1;
                    char* adr_ev_list_now_64 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_155;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_155; // Fixed void pointer dereference
                    uint32_t $a2_156 = data_af296_2;
                    uint32_t $a3_449 = data_af2aa_1;
                    char* adr_ev_list_now_65 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_157;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_157; // Fixed void pointer dereference
                    uint32_t $a2_158 = data_af298_2;
                    uint32_t $a3_456 = data_af2ac_1;
                    char* adr_ev_list_now_66 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_159;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_159; // Fixed void pointer dereference
                    uint32_t $a2_160 = data_af29a_2;
                    uint32_t $a3_463 = data_af2ae_1;
                    char* adr_ev_list_now_67 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_161;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_161; // Fixed void pointer dereference
                    $a2_53 = data_af29c_2;
                    uint32_t $v1_35 = data_af2b0_1;
                    char* adr_ev_list_now_9 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                ...
                if ($t3_205 < ev_now_1)
                {
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 4)) = data_af2b6; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 8)) = data_af2b8[0]; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0xc)) = data_af2b8[2][0]; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x10)) = data_af2b8[4][0]; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x14)) = data_af2b8[6][0]; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x18)) = data_af2b8[8][0]; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x1c)) = data_af2c2; // Fixed void pointer dereference
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x20)) = data_af2c4; // Fixed void pointer dereference
                }
                else
                {
                    ...
                    **&adr_ctc_map2cut_y_now = $a2_166;
                    ...
                    if ($a3_478 >= $a2_169)
                    {
                        char* adr_ev_list_now_69 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    {
                        char* adr_ev_list_now_68 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 4)) = $a2_170; // Fixed void pointer dereference
                    uint32_t $a2_171 = data_af2a4_2;
                    uint32_t $a3_485 = data_af2b8_1[0];
                    char* adr_ev_list_now_70 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_172;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 8)) = $a2_172; // Fixed void pointer dereference
                    uint32_t $a2_173 = data_af2a6_2;
                    uint32_t $a3_492 = data_af2b8_2[2][0];
                    char* adr_ev_list_now_71 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_174;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0xc)) = $a2_174; // Fixed void pointer dereference
                    uint32_t $a2_175 = data_af2a8_2;
                    uint32_t $a3_499 = data_af2b8_3[4][0];
                    char* adr_ev_list_now_72 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_176;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x10)) = $a2_176; // Fixed void pointer dereference
                    uint32_t $a2_177 = data_af2aa_2;
                    uint32_t $a3_506 = data_af2b8_4[6][0];
                    char* adr_ev_list_now_73 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_178;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x14)) = $a2_178; // Fixed void pointer dereference
                    uint32_t $a2_179 = data_af2ac_2;
                    uint32_t $a3_513 = data_af2b8_5[8][0];
                    char* adr_ev_list_now_74 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_180;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x18)) = $a2_180; // Fixed void pointer dereference
                    uint32_t $a2_181 = data_af2ae_2;
                    uint32_t $a3_520 = data_af2c2_1;
                    char* adr_ev_list_now_75 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    uint32_t $a2_182;
                    ...
                    *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x1c)) = $a2_182; // Fixed void pointer dereference
                    $a2_53 = data_af2b0_2;
                    uint32_t $v1_38 = data_af2c4_1;
                    char* adr_ev_list_now_10 = (char*)(adr_ev_list_now); // Fixed void pointer assignment
                    ...
                    label_5a5fc:
                        ...
                        *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x20)) = $v0_20 / $a0_13 + $a2_53; // Fixed void pointer dereference
                    }
                    else
                    {
                    ...
                    label_5a5bc:
                        ...
                        *((int32_t*)((char*)adr_ctc_map2cut_y_now_2 + 0x20)) = $a2_53 - $v0_17 / $a0_12; // Fixed void pointer dereference
                    }
                }
            }
            else
            {
                **&adr_ctc_map2cut_y_now = param_adr_gam_y_array;
                adr_ctc_map2cut_y_now_1 = adr_ctc_map2cut_y_now;
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 4)) = data_af20e; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 8)) = data_af210; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0xc)) = data_af212; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x10)) = data_af214; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x14)) = data_af216; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x18)) = data_af218; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x1c)) = data_af21a; // Fixed void pointer dereference
                *((int32_t*)((char*)adr_ctc_map2cut_y_now_1 + 0x20)) = data_af21c; // Fixed void pointer dereference
            }
        }
    }
    ...
    {
        *(&min_kneepoint_x + $v0_23) = *(&param_adr_min_kneepoint_array_def + $v0_23);
        *(&map_kneepoint_x + $v0_23) = *(&param_adr_map_kneepoint_array + $v0_23);
        
        if (i < 9)
            *(&ctc_kneepoint_x + $v0_23) = *(&param_adr_ctc_kneepoint_array + $v0_23);
    ...
    char* adr_light_end_now_1 = (char*)(adr_light_end_now); // Fixed void pointer assignment
    data_d03dc_1 = &ctc_kneepoint_y;
    data_d0410_1 = adr_light_end_now_1;
    char* adr_block_light_now_3 = (char*)(adr_block_light_now); // Fixed void pointer assignment
    ...
    if ($t7_7 == 1)
    {
        ...
        char* $a0_24 = (char*)(&map_kneepoint_y); // Fixed void pointer assignment
        char* i_2 = (char*)(&map_kneepoint_y_pre); // Fixed void pointer assignment
        int32_t $t5_13 = 0;
            int32_t j = 0;
            int32_t $v0_24 = 0;
        ...
        do
        {
            ...
            char* $v1_50 = (char*)($a0_24); // Fixed void pointer assignment
            
            if (!$v1_44)
            {
                    char* $a1_53 = (char*)(i_2 + (j_1 << 2)); // Fixed void pointer assignment
            ...
            else
            {
                ...
                char* i_3 = (char*)(i_2); // Fixed void pointer assignment
                char* $t3_268 = (char*)($a0_24); // Fixed void pointer assignment
