...

{
    ...
    int32_t $s5 = data_9ab08;
    int32_t $hi = $s5 % mdns_y_sta_blk_size_intp_1;
    int32_t $s4 = data_9ab04;
    ...
    int32_t $s2_8 =
    int32_t $s2_15 = data_cb43c << 8 | data_cb440 << 0x10 | data_cb438 | data_cb444 << 0x18;
    int32_t $s2_22 = data_cb44c << 8 | data_cb450 << 0x10 | data_cb448 | data_cb454 << 0x18;
    int32_t $s1_18 = data_cb45c << 8 | data_cb460 << 0x10 | data_cb458 | data_cb464 << 0x18;
    ...
    system_reg_write(0x7944, 
        ...
        data_cb42c << 8 | data_cb430 << 0x10 | mdns_y_ref_wei_sta_array | data_cb434 << 0x18;
    ...
    system_reg_write(0x7988, 
        data_cb3ec << 8 | data_cb3f0 << 0x10 | mdns_y_ref_wei_psn_array | data_cb3f4 << 0x18);
    system_reg_write(0x798c, 
        data_cb3fc << 8 | data_cb400 << 0x10 | data_cb3f8 | data_cb404 << 0x18);
    system_reg_write(0x7990, 
        data_cb40c << 8 | data_cb410 << 0x10 | data_cb408 | data_cb414 << 0x18);
    system_reg_write(0x7994, 
        data_cb41c << 8 | data_cb420 << 0x10 | data_cb418 | data_cb424 << 0x18);
