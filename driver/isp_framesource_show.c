...

{
    ...
    while (i < *($s4 + 0xe0))
    {
        ...
        {
            int32_t var_4c_1_1 = *($s1_1 + 0x24b);
            int32_t var_50_1_1 = *($s1_1 + 0x24a);
            ...
            __private_spin_lock_irqsave($s1_1 + 0x2c4, &var_40_9);
            int32_t $s0_11 = $s0_10 + private_seq_printf(arg1, "&vsd->mlock", *($s1_1 + 0x218));
            void* $v1_6 = *($s1_1 + 0x210) - 0x58;
            ...
            private_spin_unlock_irqrestore($s1_1 + 0x2c4, var_40_10);
            int32_t $v0_30 =
            ...
            for (int32_t j = 0; j != 0x40; )
            {
                void* $v0_36 = *$s1_2;
                
                if ($v0_36)
                {
                    int32_t var_48_1_3 = *($v0_36 + 0x54);
                    int32_t var_4c_2_2 = *($v0_36 + 0x50);
                    uint32_t var_50_3_1 = *($v0_36 + 0x4c);
