...

{
    ...
    if (*($v1 + 0x9c) != arg1)
    {
        *(((void**)((char*)$v1 + 0xec))) = *($v1 + 0xec) | arg1 << 0x10; // Fixed void pointer dereference
        *(((void**)((char*)$v1 + 0x9c))) = arg1; // Fixed void pointer dereference
        *(((int32_t*)((char*)ispcore_1 + 0x180))) = 1; // Fixed void pointer dereference
        *(((void**)((char*)ispcore_1 + 0x184))) = arg1; // Fixed void pointer dereference
