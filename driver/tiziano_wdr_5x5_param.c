...

{
    void var_c0;
    void* var_38_1;
        char* $t4_8 = (char*)(&wdr_lut11_value_sum + i); // Fixed void pointer assignment
    ...
    do
    {
        ...
        char* $t3_1 = (char*)(&param_centre5x5_w_distance_array_def + i_1); // Fixed void pointer assignment
        int32_t $lo_3;
        int32_t $hi_2;
        int32_t $lo_4;
        int32_t $hi_3;
    ...
    for (int32_t i_3 = 0; (uintptr_t)i_3 != 0x20; )
    {
        ...
        else if ($v0_36)
        {
            ...
            *((int32_t*)$t1_8) = ($lo_5 + *(&wdr_lut1_value_sum + $v1_8)) / $v0_36; // Fixed void pointer dereference
            *((int32_t*)$t0_6) = ($lo_5 + *(&wdr_lut2_value_sum + $v1_8)) / $v0_36; // Fixed void pointer dereference
            *((int32_t*)$a3_9) = ($lo_5 + *(&wdr_lut6_value_sum + $v1_8)) / $v0_36; // Fixed void pointer dereference
        }
        else
        {
