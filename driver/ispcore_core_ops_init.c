...

{
    ...
    if ($s0 && $s0 < 0xfffff001)
    {
        ...
        if ($v0_3 != 1)
        {
            ...
            __private_spin_lock_irqsave($s0 + 0xdc, &var_18_130);
            int32_t $a1_1 = var_18_131;
            
            if (*($s0 + 0xe8) != 2)
            {
                private_spin_unlock_irqrestore($s0 + 0xdc, $a1_1);
                isp_printf(2, "Err [VIC_INT] : mipi ch0 vcomp err !!!\\n", *($s0 + 0xe8));
                return 0xffffffff;
            }
            ...
            if ($v1_1 < 0x1001 && $v0_5 < 0x1001)
            {
                ...
                *($s0 + 0x142) = $v0_5;
                ...
                {
                    int32_t i = 0;
                    void* $a2_4 = &isp_output_fmt[*($s0 + 0x14c) * 0x2c];
                    
                    while (i < *($s0 + 0x154))
                    {
                        void* $v0_11 = i * 0xc4 + *($s0 + 0x150);
                        i += 1;
            ...
            {
                isp_printf(2, "Err [VIC_INT] : mipi ch1 vcomp err !!!\\n", $a2_3);
                $v0_6 = *($s0 + 0xf4);
            }
            ...
            void var_6c_17;
            void* $v1_32 = &var_6c_18;
            var_78_37 = *($s0 + 0x124);
            int32_t var_74_1_2 = *($s0 + 0x128);
            char* $v0_22 = **($s0 + 0x120);
            uint32_t i_1;
            ...
            int16_t var_2c_1_14 = *($v0_23 + 0xda);
            int16_t var_46_1_1 = *($v0_23 + 0xa6);
            int16_t var_44_1_4 = *($v0_23 + 0xa8);
            int16_t var_42_1_1 = *($v0_23 + 0xaa);
            int32_t var_40_1_10 = *($v0_23 + 0xac);
            int32_t var_28_1_8 = *($v0_23 + 0xdc);
            int16_t var_3c_1_8 = *($v0_23 + 0xb0);
            uint16_t var_3a_1_1 = $a2_5;
            int16_t var_38_1_18 = *($v0_23 + 0xb4);
            int16_t var_36_1_2 = *($v0_23 + 0xb6);
            int16_t var_34_1_15 = *($v0_23 + 0xb8);
            int16_t var_32_1_2 = *($v0_23 + 0xba);
            int32_t var_24_1_4 = *($v0_23 + 0xe0);
            *($v0_23 + 0xbc) = ($a1_2 & 0xffff) * 0xf4240 / ($a1_2 >> 0x10) / $a2_5;
            int16_t var_30_1_19 = *(*($s0 + 0x120) + 0xbc);
            int32_t var_1c_1_5 = *($s0 + 0x17c);
            tisp_init(&var_78_38, $s0 + 0x1d8);
            int32_t $v0_27 =
                private_kthread_run(isp_fw_process, 0, "Err [VIC_INT] : mipi ch3 vcomp err !!!\\n");
            *($s0 + 0x1b8) = $v0_27;
            
            if (!$v0_27 || $v0_27 >= 0xfffff001)
            {
