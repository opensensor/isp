...

{
    ...
    memcpy(&y_sp_uu_stren_array, &data_9e95c_1[9], 0x24);
    memcpy(&y_sp_uu_par_cfg_array, &data_9e95c_2[0x12], 0x10);
    ...
    memcpy(&y_sp_fl_par_cfg_array, &data_9ea68_1[9], 8);
    ...
    memcpy(&y_sp_b_wei_np_array, &data_9eb4c_1[0x10], 0x40);
