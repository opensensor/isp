...
{
    char* $s7 = *((char*)arg1 + 0x70); // Fixed void pointer arithmetic
        char* $v1_22 = (char*)(*(*($s7 + 0x2c) + 0xd4)); // Fixed void pointer assignment
        char* $v0_96 = *((char*)$v1_22 + 0x120); // Fixed void pointer arithmetic
    ...
    else
    {
            ...
            else
            {
                ...
                else if ((uintptr_t)arg2 >= 0xc0045628)
                {
                    ...
                    else if ((uintptr_t)arg2 == 0xc00456e1)
                    {
                        ...
                        int32_t var_8c;
                        *(((void**)((char*)awb_info_mine_1 + 0x10))) = var_8c; // Fixed void pointer dereference
                        int32_t var_88;
                        *(((void**)((char*)awb_info_mine_1 + 0x14))) = var_88; // Fixed void pointer dereference
                        int32_t var_84;
                        *(((void**)((char*)awb_info_mine_1 + 0x18))) = var_84; // Fixed void pointer dereference
                        int32_t var_80;
                        *(((void**)((char*)awb_info_mine_1 + 0x1c))) = var_80; // Fixed void pointer dereference
                        *(((void**)((char*)awb_info_mine_1 + 8))) = var_94; // Fixed void pointer dereference
                        *(((void**)((char*)awb_info_mine_1 + 0xc))) = var_90; // Fixed void pointer dereference
                        $s6_1 = 0;
        ...
        {
            char* $s0_13 = *((char*)$s7 + 0x2c); // Fixed void pointer arithmetic
            char* $s2_24 = *((char*)$s0_13 + 0xd4); // Fixed void pointer arithmetic
        ...
        else if ((uintptr_t)arg2 >= 0x800456d9)
        {
            ...
            if ((uintptr_t)arg2 == 0x800456dd)
            {
                ...
                char* $s5_1 = *((char*)$s6_5 + 0x120); // Fixed void pointer arithmetic
            ...
            else if ((uintptr_t)arg2 < 0x800456de)
            {
                ...
                {
                    char* $s0_2 = *((char*)$s7 + 0x2c); // Fixed void pointer arithmetic
                    char* $v0_109 = *((char*)$s0_2 + 0xd4); // Fixed void pointer arithmetic
                        char* $s1_16 = *((char*)$v0_109 + 0x120); // Fixed void pointer arithmetic
            ...
            else
            {
                ...
                if ((uintptr_t)arg2 != 0x800856d5)
                {
                    ...
                    int32_t $a2_12 = isp_printf(); // Fixed: macro call, removed arguments;
                    char* $v0_91 = *((char*)$s2_23 + 0x120); // Fixed void pointer arithmetic
            ...
            if ($a2_4 != *($s7 + 0x10c))
            {
                ...
                while ($s2_2 < $v0_36)
                {
                    ...
                    else
                    {
                        ...
                        *(((void**)((char*)$v0_39 + 8))) = $v0_39; // Fixed void pointer dereference
                        *(((void**)((char*)$v0_39 + 0xc))) = $t0_2; // Fixed void pointer dereference
                        *(((void**)((char*)$v0_39 + 0x10))) = $t2_1; // Fixed void pointer dereference
                        *(((void**)((char*)$v0_39 + 0x14))) = $t1_2; // Fixed void pointer dereference
                        *(((int32_t*)((char*)$v0_39 + 7))) = 3; // Fixed void pointer dereference
                        *(((void**)((char*)$t0_2 + 8))) = $t0_2; // Fixed void pointer dereference
                        *(((void**)((char*)$t0_2 + 0xc))) = $v0_39; // Fixed void pointer dereference
                        *(((void**)((char*)$t0_2 + 0x10))) = $v0_39 + 8; // Fixed void pointer dereference
                        *(((void**)((char*)$t0_2 + 0x14))) = $t1_2; // Fixed void pointer dereference
                ...
                *(((void**)((char*)$s7 + 0x10c))) = var_98_42; // Fixed void pointer dereference
                return 0;
            }
        }
        else
