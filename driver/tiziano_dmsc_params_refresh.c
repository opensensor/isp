...

{
    ...
    memcpy(&dmsc_hv_stren_array, &data_9dea8_1[9], 0x24);
    memcpy(&dmsc_aa_thres_1_array, U"ddddddddddd", 0x24);
    memcpy(&dmsc_aa_stren_array, &data_9def0_1[9], 0x24);
    ...
    memcpy(&dmsc_alias_par_array, &data_9e068_1[9], 0x10);
    ...
    memcpy(&dmsc_sp_d_b_stren_array, &data_9e0d0_2[9], 0x24);
    ...
    memcpy(&dmsc_sp_ud_oe_stren_array, &data_9e318_1[9], 0x24);
    ...
    memcpy(&dmsc_fc_t1_stren_array, &data_9e45c_1[9], 0x24);
    ...
    memcpy(&dmsc_sp_d_b_stren_wdr_array, &data_9e658_1[9], 0x24);
    memcpy(&dmsc_sp_ud_w_stren_wdr_array, &data_9e658_2[0x12], 0x24);
    memcpy(&dmsc_sp_ud_b_stren_wdr_array, 0x9e6c4, 0x24);
    memcpy(&dmsc_awb_gain, 0x9e6e8, 0xc);
    uint32_t $a0 = data_9a44c_2;
