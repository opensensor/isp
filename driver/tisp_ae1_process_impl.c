...

{
    ...
    ev1_cache = fix_point_mult3_32(_AePointPos_1, data_d04a8_5 << (_AePointPos_1 & 0x1f), data_d04ac_3);
    ad1_cache = fix_point_mult2_32(_AePointPos_1, data_d04ac_4, data_d04b0_1);
    ...
    if (data_b0e18_1 == 1)
    {
        ...
        while (true)
        {
            ...
            *($a3_13 + 0xafbb4) = ev1_cache;
            *($a3_13 + 0xafb8c) = ad1_cache;
            $t1_2 -= 1;
        }
    ...
    JZ_Isp_Ae_Dg2reg(_AePointPos_1, &var_30_22, *$v1_7, &var_38_43);
    system_reg_write_ae(3, 0x100c, var_30_23);
    system_reg_write_ae(3, 0x1010, var_2c_12);
    return 0;
}
