...

{
    ...
    do
    {
        ...
        if (sdns_wdr_en_1)
        {
            ...
            *(sdns_h_s_10_array_now + i) = $t0_182;
            uint32_t $t0_189;
            ...
            *(sdns_h_s_11_array_now + i) = $t0_189;
            uint32_t $t0_196;
            ...
            *(sdns_h_s_12_array_now + i) = $t0_196;
            uint32_t $t0_203;
            ...
            *(sdns_h_s_13_array_now + i) = $t0_203;
            uint32_t $t0_210;
            ...
            *(sdns_h_s_14_array_now + i) = $t0_210;
            uint32_t $t0_217;
            ...
            *(sdns_h_s_15_array_now + i) = $t0_217;
            uint32_t $t0_224;
            ...
            *(sdns_h_s_16_array_now + i) = $t0_224;
            $t0_114 = 0x1cbe4;
        ...
        else
        {
            ...
            *(sdns_h_s_15_array_now + i) = $t0_104;
            uint32_t $t0_111;
            ...
            *(sdns_h_s_16_array_now + i) = $t0_111;
            $t0_114 = 0x1c8b0;
            $s6_34 = sdns_ave_thres_array_now + i;
        }
    ...
    /* tailcall */
    return tisp_sdns_all_reg_refresh(data_9a9c4_5 + 0x200);
}
