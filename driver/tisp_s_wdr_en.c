...

{
    ...
    int32_t var_2c_21 = $v0_3;
    uint32_t var_30_26 = arg1;
    isp_printf(0, "vic_done_gpio%d", "tisp_s_wdr_en");
    int32_t $a1_3;
    int32_t $s1;
    
    if (arg1 != 1)
    {
        int32_t $s1_1 = data_94b3c_1;
        data_b2e74_10 = 0;
    ...
    else
    {
        ...
        int32_t var_2c_1_10 = $s1;
        uint32_t var_30_1_16 = arg1;
        isp_printf(0, "vic_done_gpio%d", "tisp_s_wdr_en");
        data_b2e74_11 = arg1;
        $a1_3 = 0x10;
    }
