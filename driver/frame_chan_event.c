...

{
    ...
    int32_t var_38 = 0;
        char* $s0_2 = (char*)($s0_1 * 0x2ec + $v0_3); // Fixed void pointer assignment
        ...
        label_1aee0:
            ...
            while (true)
            {
                ...
                if (*($s3_3 + 0x34) == *(arg3 + 8))
                {
                    ...
                    *((int32_t*)((char*)$s3_3 + 0x4c)) = 0x65; // Fixed void pointer dereference
                    ...
                    else
                    {
                        uint32_t $s3_5 = 0;
                            char $s3_6;
                                ...
                                char* var_54_1 = (char*)(&$v0_22[-0x16]); // Fixed void pointer assignment
                        ...
                        while (true)
                        {
                            ...
                            else
                            {
                                ...
                                *($v0_22 - 0x44) = var_40_8;
                                *($v0_22 - 0x2c) = 0;
                                char* $a1_4 = (char*)(*$v0_22); // Fixed void pointer assignment
                                int32_t var_3c;
                                *($v0_22 - 0x40) = var_3c_1 / 0x3e8;
                                void** $a0_9 = $v0_22[1];
                                *((int32_t*)((char*)$a1_4 + 4)) = $a0_9; // Fixed void pointer dereference
                                *$a0_9 = $a1_4;
                                *$v0_22 = 0x100100;
                                $v0_22[1] = 0x200200;
                                *($s0_2 + 0x218) -= 1;
                                ...
                                if (!$a0_14)
                                {
                                    ...
                                    if (isp_day_night_switch_drop_frame_cnt_1)
                                    {
                                        ...
                                        *((int32_t*)((char*)$s0_2 + 0x214)) = $v0_22; // Fixed void pointer dereference
                                        $v0_22[1] = $a0_17;
                                        *$v0_22 = $s0_2 + 0x210;
                                        *$a0_17 = $v0_22;
                                        $a0_14 = 1;
                                ...
                                *((int32_t*)((char*)$s0_2 + 0x220)) = &$v0_22[2]; // Fixed void pointer dereference
                                $v0_22[2] = $s0_2 + 0x21c;
                                $v0_22[3] = $v1_11;
                                *$v1_11 = &$v0_22[2];
                                *($s0_2 + 0x224) += 1;
