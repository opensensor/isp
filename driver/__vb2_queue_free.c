...

{
    ...
    *(((void**)((char*)arg1 + 0x1e8))) = $v0_1 - arg2; // Fixed void pointer dereference
    *(((void**)((char*)arg1 + 0x1ec))) = arg1 + 0x1ec; // Fixed void pointer dereference
    *(((void**)((char*)arg1 + 0x1f0))) = arg1 + 0x1ec; // Fixed void pointer dereference
    __private_spin_lock_irqsave(arg1 + 0x200, &var_20_4);
    *(((void**)((char*)arg1 + 0x1f8))) = arg1 + 0x1f8; // Fixed void pointer dereference
    *(((void**)((char*)arg1 + 0x1fc))) = arg1 + 0x1f8; // Fixed void pointer dereference
