...

{
    ...
    do
    {
        ...
        $t1 = $t1_5 + 4;
        *((int32_t*)((char*)defog_trsy0_list_now_1 + $t5_1)) = result_1; // Fixed void pointer dereference
        *((int32_t*)((char*)defog_trsy1_list_now + $t5_1)) = $s6_1; // Fixed void pointer dereference
