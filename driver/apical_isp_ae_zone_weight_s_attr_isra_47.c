#include "include/main.h"
  ...
  int32_t apical_isp_ae_zone_weight_s_attr.isra.47(int32_t* arg1)

{
    ...
    {
        char var_f8_3[0xec];
        private_copy_from_user(&var_f8_4, $a1_1, 0xe1);
        int32_t i = 0;
        int32_t $a2_1 = 0;
