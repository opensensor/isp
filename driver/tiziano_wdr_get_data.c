...

{
    ...
    {
        *((int32_t*)((char*)$v1_2 + &wdr_hist_R0)) = $t0_1 & 0x1fffff; // Fixed void pointer dereference
        *((int32_t*)((char*)$v1_2 + &wdr_hist_G0)) = ($a3_1 & 0x3ff) << 0xb | $t0_1 >> 0x15; // Fixed void pointer dereference
        *((int32_t*)((char*)$v1_2 + &wdr_hist_B0)) = $a3_1 >> 0xa & 0x1fffff; // Fixed void pointer dereference
        (&mdns_y_ass_wei_adj_value1_intp)[i >> 2] = $s0_1 & 0x1fffff;
        i += 4;
        (&mdns_c_false_edg_thres1_intp)[i >> 2] = ($a2_1 & 0x3ff) << 0xb | $s0_1 >> 0x15;
        *((int32_t*)((char*)$v1_2 + &wdr_hist_B1)) = $a2_1 >> 0xa & 0x1fffff; // Fixed void pointer dereference
        $a1 = &$a1[4];
    }
