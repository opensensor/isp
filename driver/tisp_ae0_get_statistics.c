    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            *$v1_1 = *$v0_1 & 0x1fffff;
            ...
            int32_t $a2_5 = *$v0_1;
            $v0_1 = &$v0_1[4];
            *($v1_1 + 0x380) = $a3_1 | $a2_5 >> 0x15;
            *($v1_1 + 0x704) = (*($v0_1 - 0xc) & 0x7ffffc00) >> 0xa;
            *($v1_1 + 0xe0c) = (*($v0_1 - 8) & 0xfff) << 1 | *($v0_1 - 0xc) >> 0x1f;
            *($v1_1 + 0x1190) = (*($v0_1 - 8) & 0x1fff000) >> 0xc;
            *($v1_1 + 0xa88) = (*($v0_1 - 4) & 0x3fff) << 7 | *($v0_1 - 8) >> 0x19;
        }
