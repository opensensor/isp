    ...
    *arg20 = 0;
    ...
    if ($s2_14 | $s3_5)
    {
        ...
        if (i_10 == i_11)
        {
            ...
            {
                char* $v0_319 = (char*)(arg11 + $v0_316 - 4); // Fixed void pointer assignment
        ...
        else
        {
            ...
            $v0_317 = $s0_17 << 2;
        label_2b94c:
            char* $v1_157 = (char*)(arg10 + $v0_317 - 4); // Fixed void pointer assignment
            $a3_51 = *($v1_157 + 4);
            $a2_73 = *$v1_157;
            i_16 = i_10;
            char* $v0_323 = (char*)(arg12 + $v0_317 - 4); // Fixed void pointer assignment
