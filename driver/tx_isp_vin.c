...
static struct tx_isp_subdev_internal_ops vin_subdev_internal_ops = {
    ...
    .activate_module = tx_isp_vin_activate_subdev,  /* CRITICAL FIX: Missing activate_module callback! */
};
...
static struct tx_isp_subdev_video_ops vin_subdev_video_ops = {
    ...
    .link_stream = NULL,  /* CRITICAL FIX: VIN should only be streamed via tx_isp_video_s_stream, not tx_isp_video_link_stream */
};
