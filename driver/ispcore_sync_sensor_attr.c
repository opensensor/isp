...

{
    ...
    if (arg1 && (uintptr_t)arg1 < 0xfffff001)
    {
        ...
        if ($s0_1 && $(uintptr_t)s0_1 < 0xfffff001)
        {
            ...
            char* $v0_3 = *((char*)$s0_1 + 0x120); // Fixed void pointer arithmetic
            ...
            *(((void**)((char*)$v0_3 + 0xbc))) = ($a1 & 0xffff) * 0xf4240 / ($a1 >> 0x10) / $a2; // Fixed void pointer dereference
            char* $v0_4 = *((char*)$s0_1 + 0x120); // Fixed void pointer arithmetic
