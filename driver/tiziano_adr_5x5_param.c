...

{
    ...
    do
    {
        ...
        $lo_4 = LOWD($v0_5 * $lo_1);
        i_1 += 4;
        *$t3_1 = (($lo_4 + &data_20000_10 < $lo_4 ? 1 : 0) + $lo_3 + $hi_3) << 0xe
            | ($lo_4 + &data_20000_11) >> 0x12;
